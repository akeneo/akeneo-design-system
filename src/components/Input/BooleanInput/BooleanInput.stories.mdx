...
<Meta
  ...
  argTypes={{
    ...
    clearButtonDisplay: {
      description: 'Display mode for the clear button: "full" shows icon + text, "icon" shows only icon with tooltip',
      control: {type: 'select'}, options: ['full', 'icon'],
      table: {
    ...
    fit: {
      description: 'Controls button width sizing. "fix" uses fixed widths (60px/40px); "contain" auto-sizes both buttons equally to the wider label, capped at 600px total.',
      table: {
        defaultValue: {summary: 'fix'},
      },
      control: {type: 'select'}, options: ['fix', 'contain'],
    },
  }}
  args={{
    value: null,
...
## Variation on clearButtonDisplay

<Canvas>
  <Story name="ClearButtonDisplay">
    {args => {
      return (
        <>
          <BooleanInput {...args} value={true} clearable={true} clearButtonDisplay={'full'} />
          <BooleanInput {...args} value={true} clearable={true} clearButtonDisplay={'icon'} />
        </>
      );
    }}
  </Story>
...
<Canvas>
  <Story name="Fit">
    {args => {
      return (
        <>
          <BooleanInput {...args} value={true} fit={'fix'} yesLabel={'Yes'} noLabel={'No'} />
          <BooleanInput {...args} value={true} fit={'contain'} yesLabel={'Enabled'} noLabel={'Disabled'} />
          <BooleanInput {...args} value={false} fit={'contain'} yesLabel={'Enabled'} noLabel={'Disabled'} />
          <BooleanInput {...args} value={null} fit={'contain'} yesLabel={'A very long enabled label'} noLabel={'A very long disabled label'} />
          <BooleanInput {...args} size={'small'} value={null} fit={'contain'} yesLabel={'A very long enabled label'} noLabel={'A very long disabled label'} />
        </>
      );
    }}
  </Story>
