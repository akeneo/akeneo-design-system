...
<Meta
  ...
  argTypes={{
    level: {control: {type: 'select'}, options: ['primary', 'success', 'secondary', 'tertiary', 'warning', 'danger']},
    ...
    {args => {
      return (
        <>
          ...
          <SplitButton {...args} level="success" label="Success">
            <SplitButton.Item onClick={() => {}}>Item 1</SplitButton.Item>
            <SplitButton.Item onClick={() => {}}>Item 2</SplitButton.Item>
          </SplitButton>
    ...
    {args => {
      return (
        <>
            ...
            <SplitButton {...args} ghost={true} level="success" label="Success">
              <SplitButton.Item onClick={() => {}}>Item 1</SplitButton.Item>
              <SplitButton.Item onClick={() => {}}>Item 2</SplitButton.Item>
            </SplitButton>
    ...
    {args => {
      return (
        <>
            ...
            <SplitButton {...args} active={true} level="success" label="success">
                <SplitButton.Item onClick={() => {}}>Item 1</SplitButton.Item>
                <SplitButton.Item onClick={() => {}}>Item 2</SplitButton.Item>
            </SplitButton>
