...
<Canvas>
  <Story name="With image">
    {args => {
      return (
        <>
          <Avatar {...args} avatarUrl={getStaticImage('akeneo_32_32.jpg')} />
        </>
      );
    }}
  </Story>
        ...
        <>
          ...
          >
            <Avatar
              ...
              lastName={'Doe'}
              username={'a'}
              avatarUrl={getStaticImage('akeneo_32_32.jpg')}
            />
            <Avatar {...args} firstName={'Bertrand'} lastName={'Doe'} username={'b'} />
            <Avatar
              {...args}
              ...
              lastName={'Doe'}
              username={'c'}
              avatarUrl={getStaticImage('bkeneo_32_32.jpg')}
            />
            <Avatar {...args} firstName={'Danny'} lastName={'Doe'} username={'d'} />
            <Avatar
              {...args}
              ...
              lastName={'Doe'}
              username={'e'}
              avatarUrl={getStaticImage('ckeneo_32_32.jpg')}
            />
            <Avatar {...args} firstName={'Fred'} lastName={'Doe'} username={'f'} />
            <Avatar {...args} firstName={'Gus'} lastName={'Doe'} username={'g'} />
            <Avatar {...args} firstName={'Helen'} lastName={'Doe'} username={'h'} />
