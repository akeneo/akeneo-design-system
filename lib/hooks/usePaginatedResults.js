...
var usePaginatedResults = function (fetcher, dependencies, shouldFetch) {
    ...
    var _c = (0, _1.useBooleanState)(), isFetching = _c[0], startFetching = _c[1], stopFetching = _c[2];
    var _d = (0, _1.useBooleanState)(), isLastPage = _d[0], onLastPage = _d[1], notOnLastPage = _d[2];
    var isMounted = (0, _1.useIsMounted)();
    (0, react_1.useEffect)(function () {
        if (null === results)
            return;
        setPage(0);
        notOnLastPage();
        setResults(__spreadArray([], results, true));
    }, dependencies);
    (0, react_1.useEffect)(function () {
