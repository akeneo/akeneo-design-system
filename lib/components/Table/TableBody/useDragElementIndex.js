...
var useDragElementIndex = function () {
    ...
    var onDragStart = react_1.useCallback(function (index) { return setDraggedElementIndex(index); }, [setDraggedElementIndex]);
    var onDragEnd = react_1.useCallback(function () { return setDraggedElementIndex(null); }, [setDraggedElementIndex]);
