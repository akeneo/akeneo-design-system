...
var RowContainer = styled_components_1.default.tr(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  ", ";\n\n  ", "\n\n  ", "\n\n  ", "\n\n  ", "\n\n  &:hover > td {\n    opacity: 1;\n    ", "\n  }\n\n  &:hover > td > div {\n    opacity: 1;\n  }\n"], ["\n  ",
    ";\n\n  ",
    "\n\n  ",
    "\n\n  ",
    "\n\n  ",
    ...
    return isDragAndDroppable && styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      & > *:first-child {\n        width: 44px;\n      }\n    "], ["\n      & > *:first-child {\n        width: 44px;\n      }\n    "])));
}, function (_a) {
    var placeholderPosition = _a.placeholderPosition;
    return placeholderPosition === 'top' && styled_components_1.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      background: linear-gradient(to bottom, ", " 4px, ", " 0px);\n    "], ["\n      background: linear-gradient(to bottom, ", " 4px, ", " 0px);\n    "])), theme_1.getColor('blue', 40), theme_1.getColor('white'));
}, function (_a) {
    var placeholderPosition = _a.placeholderPosition;
    return placeholderPosition === 'bottom' && styled_components_1.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      background: linear-gradient(to top, ", " 4px, ", " 0px);\n    "], ["\n      background: linear-gradient(to top, ", " 4px, ", " 0px);\n    "])), theme_1.getColor('blue', 40), theme_1.getColor('white'));
}, function (_a) {
    var isClickable = _a.isClickable;
    return isClickable && styled_components_1.css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        background-color: ", ";\n      "], ["\n        background-color: ", ";\n      "])), theme_1.getColor('grey', 20));
});
var CheckboxContainer = styled_components_1.default.td(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  background: none !important;\n  opacity: ", ";\n  cursor: auto;\n\n  > div {\n    justify-content: center;\n  }\n"], ["\n  background: none !important;\n  opacity: ", ";\n  cursor: auto;\n\n  > div {\n    justify-content: center;\n  }\n"])), function (_a) {
    var isVisible = _a.isVisible;
    return (isVisible ? 1 : 0);
});
var HandleCell = styled_components_1.default(TableCell_1.TableCell)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  cursor: grab;\n  width: 20px;\n\n  > div {\n    justify-content: center;\n  }\n\n  :active {\n    cursor: grabbing;\n  }\n"], ["\n  cursor: grab;\n  width: 20px;\n\n  > div {\n    justify-content: center;\n  }\n\n  :active {\n    cursor: grabbing;\n  }\n"])));
var TableRow = react_1.forwardRef(function (_a, forwardedRef) {
    ...
    var _c = usePlaceholderPosition_1.usePlaceholderPosition(rowIndex), placeholderPosition = _c[0], placeholderDragEnter = _c[1], placeholderDragLeave = _c[2], placeholderDragEnd = _c[3];
