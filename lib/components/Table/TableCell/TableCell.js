...
var TableCellContainer = styled_components_1.default.td(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  color: ", ";\n  border-bottom: 1px solid ", ";\n  padding: 15px 10px;\n  max-width: 15vw;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  min-width: 0;\n\n  ", "\n"], ["\n  color: ", ";\n  border-bottom: 1px solid ", ";\n  padding: 15px 10px;\n  max-width: 15vw;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  min-width: 0;\n\n  ", "\n"])), (0, theme_1.getColor)('grey', 140), (0, theme_1.getColor)('grey', 60), function (props) {
    return props.rowTitle && (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      color: ", ";\n      font-style: italic;\n    "], ["\n      color: ", ";\n      font-style: italic;\n    "])), (0, theme_1.getColor)('brand', 100));
});
...
var TableCell = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(TableCellContainer, __assign({ ref: forwardedRef, rowTitle: rowTitle }, rest),
        react_1.default.createElement(TableCellInnerContainer, null, react_1.default.Children.map(children, function (child) {
            if (!react_1.default.isValidElement(child) || child.type !== components_1.Image)
                return child;
