...
var HeaderCellContainer = styled_components_1.default.th(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: linear-gradient(to top, ", " 1px, ", " 0px);\n  height: 44px;\n  text-align: left;\n  color: ", ";\n  font-weight: normal;\n  box-sizing: content-box;\n\n  ", ";\n"], ["\n  background: linear-gradient(to top, ", " 1px, ", " 0px);\n  height: 44px;\n  text-align: left;\n  color: ", ";\n  font-weight: normal;\n  box-sizing: content-box;\n\n  ", ";\n"])), (0, theme_1.getColor)('grey', 120), (0, theme_1.getColor)('white'), function (_a) {
    var isSorted = _a.isSorted;
    return (0, theme_1.getColor)(isSorted ? 'brand' : 'grey', 100);
}, function (_a) {
    var isSortable = _a.isSortable;
    return isSortable && (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      cursor: pointer;\n    "], ["\n      cursor: pointer;\n    "])));
});
