...
var ItemCollection = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var lastItemRef = react_1.useRef(null);
    var containerRef = hooks_1.useCombinedRefs(forwardedRef);
    ...
    usePagination_1.usePagination(containerRef, lastItemRef, onNextPage, true);
