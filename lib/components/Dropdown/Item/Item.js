...
var Item = react_1.default.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, onKeyDown = _a.onKeyDown, _b = _a.disabled, disabled = _b === void 0 ? false : _b, onClick = _a.onClick, rest = __rest(_a, ["children", "onKeyDown", "disabled", "onClick"]);
    var tall = false;
    ...
    var decoratedChildren = react_1.default.Children.map(children, function (child) {
        if (typeof child === 'string') {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(ItemLabel, { title: child }, child),
