...
var ItemContainer = styled_components_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  background: ", ";\n  height: ", "px;\n  line-height: ", "px;\n  padding: 0 20px;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  outline-style: none;\n  cursor: pointer;\n  white-space: nowrap;\n\n  &:focus {\n    box-shadow: inset 0 0 0 2px ", ";\n  }\n\n  ", "\n\n  ", "\n"], ["\n  background: ", ";\n  height: ", "px;\n  line-height: ", "px;\n  padding: 0 20px;\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  outline-style: none;\n  cursor: pointer;\n  white-space: nowrap;\n\n  &:focus {\n    box-shadow: inset 0 0 0 2px ", ";\n  }\n\n  ",
    "\n\n  ",
...
var Item = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(ItemContainer, __assign({ tall: tall, tabIndex: null === actionableRef.current && !disabled ? 0 : -1, onClick: handleClick, onKeyDown: handleKeyDown, disabled: disabled, "aria-disabled": disabled, isActive: isActive }, rest, { ref: forwardedRef }), decoratedChildren));
});
exports.Item = Item;
