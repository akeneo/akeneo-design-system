...
`,B=q.default.a`
  ...
  ${E}
`,M=i.forwardRef((D,F)=>{var w=D,{level:o="primary",ghost:e=!1,disabled:r=!1,active:n=!1,size:g="default",href:p,ariaDescribedBy:f,ariaLabel:b,ariaLabelledBy:x,children:C,onClick:$,type:m="button"}=w,h=z(w,["level","ghost","disabled","active","size","href","ariaDescribedBy","ariaLabel","ariaLabelledBy","children","onClick","type"]);const y=l=>{r||$===void 0||$(l)};return p!==void 0?_.jsx(B,d(u({$level:o,$ghost:e,$active:n,$size:g,disabled:r,"aria-describedby":f,"aria-disabled":r,"aria-label":b,"aria-labelledby":x,ref:F,role:"button",type:m,onClick:y,href:r?void 0:p},h),{children:i.Children.map(C,l=>{var a;return i.isValidElement(l)?i.cloneElement(l,{size:(a=l.props.size)!=null?a:18}):l})})):_.jsx(V,d(u({$level:o,$ghost:e,$active:n,$size:g,disabled:r,"aria-describedby":f,"aria-disabled":r,"aria-label":b,"aria-labelledby":x,ref:F,role:"button",type:m,onClick:y},h),{children:i.Children.map(C,l=>{var a;return i.isValidElement(l)?i.cloneElement(l,{size:(a=l.props.size)!=null?a:18}):l})}))});exports.Button=M;
