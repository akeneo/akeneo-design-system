...
var getColorStyle = function (_a) {
    ...
    if (ghost) {
        return (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n\n      &:hover:not([disabled]) {\n        color: ", ";\n        background-color: ", ";\n        border-color: ", ";\n      }\n\n      &:active:not([disabled]) {\n        color: ", ";\n        border-color: ", ";\n      }\n    "], ["\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n\n      &:hover:not([disabled]) {\n        color: ", ";\n        background-color: ", ";\n        border-color: ", ";\n      }\n\n      &:active:not([disabled]) {\n        color: ", ";\n        border-color: ", ";\n      }\n    "])), (0, theme_1.getColorForLevel)(level, disabled ? 80 : active ? 140 : 120), (0, theme_1.getColor)('white'), (0, theme_1.getColorForLevel)(level, disabled ? 60 : active ? 140 : 100), (0, theme_1.getColorForLevel)(level, 140), (0, theme_1.getColorForLevel)(level, 20), (0, theme_1.getColorForLevel)(level, 120), (0, theme_1.getColorForLevel)(level, 140), (0, theme_1.getColorForLevel)(level, 140));
    }
    return (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    color: ", ";\n    background-color: ", ";\n    border-color: ", ";\n\n    &:hover:not([disabled]) {\n      background-color: ", ";\n      border-color: ", ";\n    }\n\n    &:active:not([disabled]) {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "], ["\n    color: ", ";\n    background-color: ", ";\n    border-color: ", ";\n\n    &:hover:not([disabled]) {\n      background-color: ", ";\n      border-color: ", ";\n    }\n\n    &:active:not([disabled]) {\n      background-color: ", ";\n      border-color: ", ";\n    }\n  "])), (0, theme_1.getColor)('white'), (0, theme_1.getColorForLevel)(level, disabled ? 40 : active ? 140 : 100), (0, theme_1.getColorForLevel)(level, disabled ? 40 : active ? 140 : 100), (0, theme_1.getColorForLevel)(level, 120), (0, theme_1.getColorForLevel)(level, 120), (0, theme_1.getColorForLevel)(level, 140), (0, theme_1.getColorForLevel)(level, 140));
};
...
var Button = (0, react_1.forwardRef)(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(Container, __assign({ as: undefined !== href ? 'a' : 'button', level: level, ghost: ghost, disabled: disabled, active: active, size: size, "aria-describedby": ariaDescribedBy, "aria-disabled": disabled, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, ref: forwardedRef, role: "button", type: type, onClick: handleAction, href: disabled ? undefined : href }, rest), react_1.Children.map(children, function (child) {
        var _a;
