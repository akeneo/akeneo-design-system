...
var getColorStyle = function (_a) {
    ...
    if (ghost) {
        return (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n\n      &:hover:not([disabled]) {\n        color: ", ";\n        background-color: ", ";\n        border-color: ", ";\n      }\n\n      &:active:not([disabled]) {\n        color: ", ";\n        border-color: ", ";\n      }\n    "], ["\n      color: ", ";\n      background-color: ", ";\n      border-color: ", ";\n\n      &:hover:not([disabled]) {\n        color: ", ";\n        background-color: ", ";\n        border-color: ", ";\n      }\n\n      &:active:not([disabled]) {\n        color: ", ";\n        border-color: ", ";\n      }\n    "])), (0, theme_1.getColorForLevel)(level, disabled ? 80 : 120), (0, theme_1.getColor)('white'), (0, theme_1.getColorForLevel)(level, disabled ? 60 : 100), (0, theme_1.getColorForLevel)(level, 140), (0, theme_1.getColorForLevel)(level, 20), (0, theme_1.getColorForLevel)(level, 120), (0, theme_1.getColorForLevel)(level, 140), (0, theme_1.getColorForLevel)(level, 140));
    }
    return (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    color: ", ";\n    background-color: ", ";\n\n    &:hover:not([disabled]) {\n      background-color: ", ";\n    }\n\n    &:active:not([disabled]) {\n      background-color: ", ";\n    }\n  "], ["\n    color: ", ";\n    background-color: ", ";\n\n    &:hover:not([disabled]) {\n      background-color: ", ";\n    }\n\n    &:active:not([disabled]) {\n      background-color: ", ";\n    }\n  "])), (0, theme_1.getColor)('white'), (0, theme_1.getColorForLevel)(level, disabled ? 40 : 100), (0, theme_1.getColorForLevel)(level, 120), (0, theme_1.getColorForLevel)(level, 140));
};
