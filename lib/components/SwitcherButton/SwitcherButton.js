...
var Label = styled_components_1.default.label(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  cursor: pointer;\n  white-space: nowrap;\n  ", "\n"], ["\n  cursor: pointer;\n  white-space: nowrap;\n  ", "\n"])), function (_a) {
    var $inline = _a.$inline;
    return $inline
        ? (0, styled_components_1.css)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n          margin-right: 3px;\n          color: ", ";\n        "], ["\n          margin-right: 3px;\n          color: ", ";\n        "])), (0, theme_1.getColor)('grey', 140)) : (0, styled_components_1.css)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n          color: ", ";\n          text-transform: uppercase;\n          font-size: ", ";\n          line-height: ", ";\n          margin-bottom: -2px;\n        "], ["\n          color: ", ";\n          text-transform: uppercase;\n          font-size: ", ";\n          line-height: ", ";\n          margin-bottom: -2px;\n        "])), (0, theme_1.getColor)('grey', 100), (0, theme_1.getFontSize)('small'), (0, theme_1.getFontSize)('small'));
});
...
var Value = styled_components_1.default.span(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  color: ", ";\n  margin-right: 5px;\n"], ["\n  color: ", ";\n  margin-right: 5px;\n"])), function (_a) {
    var $inline = _a.$inline;
    return ($inline ? (0, theme_1.getColor)('purple', 100) : (0, theme_1.getColor)('grey', 140));
});
...
var SwitcherButton = (0, react_1.forwardRef)(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(SwitcherButtonContainer, __assign({ ref: forwardedRef }, rest),
        react_1.default.createElement(LabelAndValueContainer, { id: buttonId, onClick: onClick, "$inline": inline },
            react_1.default.createElement(Label, { htmlFor: buttonId, "$inline": inline }, label && label + ":"),
