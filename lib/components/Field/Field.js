...
var Field = react_1.default.forwardRef(function (_a, forwardedRef) {
    var label = _a.label, locale = _a.locale, channel = _a.channel, _b = _a.incomplete, incomplete = _b === void 0 ? false : _b, children = _a.children, rest = __rest(_a, ["label", "locale", "channel", "incomplete", "children"]);
    ...
    return (react_1.default.createElement(FieldContainer, __assign({ ref: forwardedRef }, rest),
        react_1.default.createElement(LabelContainer, null,
            incomplete && react_1.default.createElement(IncompleteBadge, null),
            react_1.default.createElement(Label, { htmlFor: inputId, id: labelId }, label),
