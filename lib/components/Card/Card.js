...
var Card = react_1.default.forwardRef(function (_a, forwardedRef) {
    var src = _a.src, _b = _a.fit, fit = _b === void 0 ? 'cover' : _b, _c = _a.isSelected, isSelected = _c === void 0 ? false : _c, onSelect = _a.onSelect, children = _a.children, rest = __rest(_a, ["src", "fit", "isSelected", "onSelect", "children"]);
    var badges = [];
    var texts = [];
    ...
    var toggleSelect = undefined !== onSelect ? function () { return onSelect(!isSelected); } : undefined;
    return (react_1.default.createElement(CardContainer, __assign({ ref: forwardedRef, fit: fit, isSelected: isSelected, onClick: toggleSelect }, rest),
        ...
        react_1.default.createElement(CardLabel, null,
            undefined !== onSelect && react_1.default.createElement(components_1.Checkbox, { checked: isSelected, onChange: toggleSelect }),
            texts)));
});
exports.Card = Card;
