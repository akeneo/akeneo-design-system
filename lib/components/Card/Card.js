...
var Stack = styled_components_1.default.div.attrs(function () { return ({
    ...
    var isSelected = _a.isSelected;
    return (0, theme_1.getColor)(isSelected ? 'blue' : 'grey', 100);
...
var CardGrid = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(", "px, 1fr));\n  gap: ", "px;\n\n  ", "\n"], ["\n  display: grid;\n  grid-template-columns: repeat(auto-fill, minmax(", "px, 1fr));\n  gap: ", "px;\n\n  ", "\n"])), function (_a) {
    ...
    var size = _a.size;
    return 'big' === size && (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      ", " {\n        ::before {\n          transform: translate(8px, 10px);\n        }\n\n        ::after {\n          transform: translate(4px, 5px);\n        }\n      }\n    "], ["\n      ", " {\n        ::before {\n          transform: translate(8px, 10px);\n        }\n\n        ::after {\n          transform: translate(4px, 5px);\n        }\n      }\n    "])), Stack);
});
...
var CardContainer = styled_components_1.default.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  line-height: 20px;\n  font-size: ", ";\n  color: ", ";\n  cursor: ", ";\n  text-decoration: none;\n\n  img {\n    position: absolute;\n    top: 0;\n    width: ", ";\n    height: ", ";\n    box-sizing: border-box;\n    ", "\n  }\n"], ["\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  width: 100%;\n  line-height: 20px;\n  font-size: ", ";\n  color: ", ";\n  cursor: ", ";\n  text-decoration: none;\n\n  img {\n    position: absolute;\n    top: 0;\n    width: ", ";\n    height: ", ";\n    box-sizing: border-box;\n    ", "\n  }\n"])), (0, theme_1.getFontSize)('default'), (0, theme_1.getColor)('grey', 120), function (_a) {
    ...
    return !isLoading && (0, styled_components_1.css)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n        border-style: solid;\n        border-width: ", "px;\n        border-color: ", ";\n      "], ["\n        border-style: solid;\n        border-width: ", "px;\n        border-color: ", ";\n      "])), isSelected ? 2 : 1, (0, theme_1.getColor)(isSelected ? 'blue' : 'grey', 100));
});
...
var CardComponent = (0, react_1.forwardRef)(function (_a, forwardedRef) {
    ...
    react_1.default.Children.forEach(children, function (child) {
        if (typeof child === 'string') {
            ...
            if ((0, react_1.isValidElement)(child) && components_1.Link === child.type) {
                linkProps = __assign(__assign({}, child.props), { href: disabled ? undefined : child.props.href });
            }
            else if ((0, react_1.isValidElement)(child) && BadgeContainer === child.type) {
    ...
    return (react_1.default.createElement(CardContainer, __assign({ ref: forwardedRef, isSelected: isSelected, as: isLink ? 'a' : undefined, actionable: isLink || undefined !== onClick, onClick: handleClick, disabled: disabled, stacked: stacked, isLoading: null === src }, linkProps, rest),
        react_1.default.createElement(ImageContainer, null,
            ...
            react_1.default.createElement(components_1.Image, { fit: fit, src: src, alt: cardText, loading: loading })),
