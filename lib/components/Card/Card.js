...
var Card = function (_a) {
    ...
    return (react_1.default.createElement(CardContainer, __assign({ isSelected: isSelected, actionable: 0 < links.length || undefined !== onClick, onClick: handleClick, disabled: disabled, stacked: stacked, isLoading: null === src }, rest),
        react_1.default.createElement(ImageContainer, null,
            ...
            react_1.default.createElement(components_1.Image, { fit: fit, src: src, alt: texts[0] })),
