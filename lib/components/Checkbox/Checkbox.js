...
`,J=n.default.div`
  ...
  height: 20px;
  width: 20px;
  border: 1px solid ${a.getColor("grey80")};
  border-radius: 3px;
  overflow: hidden;
  ...
  ${e=>e.checked&&e.readOnly&&s.css`
      background-color: ${a.getColor("blue20")};
      border-color: ${a.getColor("blue40")};
    `}

  ${e=>!e.checked&&e.readOnly&&s.css`
      background-color: ${a.getColor("grey60")};
      border-color: ${a.getColor("grey100")};
    `}
`,N=n.default.label`
  ...
  ${e=>e.readOnly&&s.css`
    ...
    `}
`,O=B.default.forwardRef((Q,z)=>{var b=Q,{checked:e=!1,onChange:o,readOnly:r=!1,children:t,title:_,"aria-label":w,tabIndex:k}=b,j=v(b,["checked","onChange","readOnly","children","title","aria-label","tabIndex"]);const h=m.useId("checkbox_"),g=m.useId("label_"),x=e===!0,C=e==="mixed",d=i=>{if(!(!o||r)){switch(e){case!0:o(!1,i);break;case"mixed":case!1:o(!0,i);break}i.preventDefault(),i.stopPropagation()}},P=L.useShortcut(A.Key.Space,d,z),R=t?{"aria-labelledby":g,id:h}:{};return c.jsxs(H,f(u({},j),{children:[c.jsx(J,f(u({checked:x||C,readOnly:r,title:_,role:"checkbox",ref:P,"aria-checked":x,tabIndex:k!==void 0?k:r?-1:0,onClick:d,"aria-label":w},R),{children:C?c.jsx(K.CheckPartialIcon,{size:18}):c.jsx(q,{size:18})})),t?c.jsx(N,{onClick:d,id:g,readOnly:r,htmlFor:h,children:t}):null]}))});exports.Checkbox=O;
