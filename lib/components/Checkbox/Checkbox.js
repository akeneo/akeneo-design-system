...
var Checkbox = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(Container, __assign({}, rest),
        react_1.default.createElement(CheckboxContainer, __assign({ checked: isChecked || isMixed, readOnly: readOnly, title: title, role: "checkbox", ref: ref, "aria-checked": isChecked, tabIndex: readOnly ? -1 : 0, onClick: handleChange, "aria-label": ariaLabel }, forProps), isMixed ? react_1.default.createElement(icons_1.CheckPartialIcon, { size: 18 }) : react_1.default.createElement(TickIcon, { size: 18 })),
