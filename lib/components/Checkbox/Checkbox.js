...
var checkTick = (0, styled_components_1.keyframes)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  to {\n    stroke-dashoffset: 0;\n  }\n"], ["\n  to {\n    stroke-dashoffset: 0;\n  }\n"])));
...
var CheckboxContainer = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  background-color: transparent;\n  height: 20px;\n  width: 20px;\n  border: 1px solid ", ";\n  border-radius: 3px;\n  overflow: hidden;\n  background-color: ", ";\n  transition: background-color 0.2s ease-out;\n  box-sizing: border-box;\n  color: ", ";\n  flex-shrink: 0;\n\n  ", "\n\n  ", "\n\n  ", "\n"], ["\n  background-color: transparent;\n  height: 20px;\n  width: 20px;\n  border: 1px solid ", ";\n  border-radius: 3px;\n  overflow: hidden;\n  background-color: ", ";\n  transition: background-color 0.2s ease-out;\n  box-sizing: border-box;\n  color: ", ";\n  flex-shrink: 0;\n\n  ", "\n\n  ", "\n\n  ", "\n"])), (0, theme_1.getColor)('grey80'), (0, theme_1.getColor)('grey20'), (0, theme_1.getColor)('white'), function (props) {
    ...
    return props.checked &&
        props.readOnly && (0, styled_components_1.css)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      background-color: ", ";\n      border-color: ", ";\n    "], ["\n      background-color: ", ";\n      border-color: ", ";\n    "])), (0, theme_1.getColor)('blue20'), (0, theme_1.getColor)('blue40'));
}, function (props) {
    return !props.checked &&
        props.readOnly && (0, styled_components_1.css)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      background-color: ", ";\n      border-color: ", ";\n    "], ["\n      background-color: ", ";\n      border-color: ", ";\n    "])), (0, theme_1.getColor)('grey60'), (0, theme_1.getColor)('grey100'));
});
var LabelContainer = styled_components_1.default.label(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  color: ", ";\n  font-weight: 400;\n  font-size: ", ";\n  padding-left: 10px;\n\n  ", "\n"], ["\n  color: ", ";\n  font-weight: 400;\n  font-size: ", ";\n  padding-left: 10px;\n\n  ", "\n"])), (0, theme_1.getColor)('grey140'), (0, theme_1.getFontSize)('big'), function (props) {
    return props.readOnly && (0, styled_components_1.css)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), (0, theme_1.getColor)('grey100'));
});
var Checkbox = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var checkboxId = (0, hooks_1.useId)('checkbox_');
    ...
    var ref = (0, hooks_1.useShortcut)(shared_1.Key.Space, handleChange, forwardedRef);
