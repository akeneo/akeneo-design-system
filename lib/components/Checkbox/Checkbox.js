...
var Checkbox = react_1.default.forwardRef(function (_a, forwardedRef) {
    var _b = _a.checked, checked = _b === void 0 ? false : _b, onChange = _a.onChange, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c, children = _a.children, title = _a.title, ariaLabel = _a["aria-label"], rest = __rest(_a, ["checked", "onChange", "readOnly", "children", "title", 'aria-label']);
    ...
    return (react_1.default.createElement(Container, __assign({}, rest),
        react_1.default.createElement(CheckboxContainer, __assign({ checked: isChecked || isMixed, readOnly: readOnly, title: title, role: "checkbox", ref: ref, "aria-checked": isChecked, tabIndex: readOnly ? -1 : 0, onClick: handleChange, "aria-label": ariaLabel }, forProps), isMixed ? react_1.default.createElement(icons_1.CheckPartialIcon, { size: 18 }) : react_1.default.createElement(TickIcon, { size: 20 })),
