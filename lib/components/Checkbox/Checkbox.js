...
`,N=n.default.label`
  ...
  ${e=>e.readOnly&&s.css`
    ...
    `}
`,O=B.default.forwardRef((Q,z)=>{var h=Q,{checked:e=!1,onChange:o,readOnly:r=!1,children:t,title:w,"aria-label":_,tabIndex:k}=h,j=v(h,["checked","onChange","readOnly","children","title","aria-label","tabIndex"]);const b=m.useId("checkbox_"),g=m.useId("label_"),x=e===!0,C=e==="mixed",d=i=>{if(!(!o||r)){switch(e){case!0:o(!1,i);break;case"mixed":case!1:o(!0,i);break}i.preventDefault(),i.stopPropagation()}},P=L.useShortcut(A.Key.Space,d,z),R=t?{"aria-labelledby":g,id:b}:{};return c.jsxs(H,f(u({},j),{children:[c.jsx(J,f(u({checked:x||C,readOnly:r,title:w,role:"checkbox",ref:P,"aria-checked":x,tabIndex:k!==void 0?k:r?-1:0,onClick:d,"aria-label":_},R),{children:C?c.jsx(K.CheckPartialIcon,{size:18}):c.jsx(q,{size:18})})),t?c.jsx(N,{onClick:d,id:g,readOnly:r,htmlFor:b,children:t}):null]}))});exports.Checkbox=O;
