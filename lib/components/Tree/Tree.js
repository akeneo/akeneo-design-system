...
`,$e=({isLoading:e,isLeaf:o,selected:r})=>{if(e)return l.jsx(ge,{size:24});const n=r===!0||r==="mixed";return o?n?l.jsx(fe,{size:24}):l.jsx(de,{size:24}):n?l.jsx(ue,{size:24}):l.jsx(he,{size:24})},Ie=s.default.forwardRef(function(Te,W){var q=Te,{label:o,value:r,children:n,isLeaf:c=!1,selected:u=!1,isLoading:P=!1,selectable:B=!1,readOnly:O=!1,onChange:p,onOpen:m,onClose:b,onClick:C,defaultOpen:j=!1,_isRoot:V=!0,valueLabel:T,highlight:v="",additional:D,hideIcons:J=!1,code:k}=q,M=N(q,["label","value","children","isLeaf","selected","isLoading","selectable","readOnly","onChange","onOpen","onClose","onClick","defaultOpen","_isRoot","valueLabel","highlight","additional","hideIcons","code"]);const d=[];s.default.Children.forEach(n,a=>{if(a!==null){if(!y.isValidElement(a))throw new Error("Tree component only accepts Tree as children");d.push(a)}});const[f,w]=s.default.useState(d.length>0);y.useEffect(()=>{d.length>0&&j&&w(!0)},[d.length,j]);const F=s.default.useCallback(()=>{w(!0),m&&m(r)},[m,r]),S=s.default.useCallback(()=>{w(!1),b&&b(r)},[b,r]),$=s.default.useCallback(()=>{c||(f?S():F())},[f,S,F,c]),G=s.default.useCallback(()=>{C?C(r):$()},[$,C,r]),K=s.default.useCallback((a,Q)=>{p&&p(r,a,Q)},[p,r]),_=l.jsxs(se,L(E({ref:W,role:"treeitem","aria-expanded":f},M),{children:[l.jsxs(Ce,{$selected:u,children:[l.jsx(ve,{disabled:c,role:"button",onClick:$,children:!c&&l.jsx(ce,{$isFolderOpen:f,size:14})}),B&&l.jsx(je,{checked:u,onChange:K,readOnly:O}),l.jsxs(we,{onClick:G,$selected:u,title:o,"aria-selected":!!u,children:[!J&&l.jsx($e,{isLoading:P,isLeaf:c,selected:u}),k?l.jsxs(pe,{children:[l.jsx(me,{children:k}),l.jsx(be,{children:l.jsx(I.Highlight,{highlight:v,children:o})})]}):l.jsx(I.Highlight,{highlight:v,children:o})," ",D,T&&l.jsx(xe,{children:l.jsx(I.Highlight,{highlight:v,children:T})})]})]}),f&&!c&&d.length>0&&l.jsx(ae,{role:"group",children:d.map(a=>s.default.cloneElement(a,{key:JSON.stringify(a.props.value),defaultOpen:j,_isRoot:!1}))})]}));return V?l.jsx("ul",{role:"tree",children:_}):_}),ye=Object.assign(Ie,{displayName:"Tree"});exports.Tree=ye;
