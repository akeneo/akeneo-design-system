...
var folderIconCss = (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  vertical-align: middle;\n  transition: color 0.2s ease;\n  margin-right: 5px;\n"], ["\n  vertical-align: middle;\n  transition: color 0.2s ease;\n  margin-right: 5px;\n"])));
...
}, (0, theme_1.getColor)('grey100'));
var TreeLeafNotSelectedIcon = (0, styled_components_1.default)(icons_1.FolderIcon)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), folderIconCss);
var TreeFolderSelectedIcon = (0, styled_components_1.default)(icons_1.FoldersPlainIcon)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  ", "\n  color: ", ";\n"], ["\n  ", "\n  color: ", ";\n"])), folderIconCss, (0, theme_1.getColor)('blue100'));
var TreeLeafSelectedIcon = (0, styled_components_1.default)(icons_1.FolderPlainIcon)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  ", "\n  color: ", ";\n"], ["\n  ", "\n  color: ", ";\n"])), folderIconCss, (0, theme_1.getColor)('blue100'));
var TreeFolderNotSelectedIcon = (0, styled_components_1.default)(icons_1.FoldersIcon)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), folderIconCss);
var TreeLoaderIcon = (0, styled_components_1.default)(icons_1.LoaderIcon)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  ", "\n  color: ", ";\n"], ["\n  ", "\n  color: ", ";\n"])), folderIconCss, (0, theme_1.getColor)('grey100'));
var TreeLine = styled_components_1.default.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  height: 40px;\n  line-height: 40px;\n  overflow: hidden;\n  width: 100%;\n  display: inline-flex;\n  align-items: center;\n  padding-right: 20px;\n  ", "\n"], ["\n  height: 40px;\n  line-height: 40px;\n  overflow: hidden;\n  width: 100%;\n  display: inline-flex;\n  align-items: center;\n  padding-right: 20px;\n  ", "\n"])), function (_a) {
    var $selected = _a.$selected;
    return $selected && (0, styled_components_1.css)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), (0, theme_1.getColor)('blue100'));
});
var NodeCheckbox = (0, styled_components_1.default)(Checkbox_1.Checkbox)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: middle;\n  margin-right: 8px;\n"], ["\n  display: inline-block;\n  vertical-align: middle;\n  margin-right: 8px;\n"])));
...
var LabelWithFolder = styled_components_1.default.button(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  ", "\n  height: 30px;\n  vertical-align: middle;\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 0 5px 0 0;\n  cursor: pointer;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  max-width: calc(100% - 35px);\n  text-align: left;\n  white-space: nowrap;\n  ", "\n  &:hover {\n    ", "\n  }\n"], ["\n  ", "\n  height: 30px;\n  vertical-align: middle;\n  background: none;\n  border: none;\n  cursor: pointer;\n  padding: 0 5px 0 0;\n  cursor: pointer;\n  text-overflow: ellipsis;\n  overflow: hidden;\n  max-width: calc(100% - 35px);\n  text-align: left;\n  white-space: nowrap;\n  ", "\n  &:hover {\n    ", "\n  }\n"])), theme_1.CommonStyle, function (_a) {
    var $selected = _a.$selected;
    return $selected && (0, styled_components_1.css)(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n      color: ", ";\n    "], ["\n      color: ", ";\n    "])), (0, theme_1.getColor)('blue100'));
}, function (_a) {
    var $selected = _a.$selected;
    return !$selected && (0, styled_components_1.css)(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n        color: ", ";\n      "], ["\n        color: ", ";\n      "])), (0, theme_1.getColor)('grey140'));
});
...
var Tree = function (_a) {
    ...
    if (subTrees.length > 0 && selectable) {
        var selectedChildren = subTrees.filter(function (subTree) { return subTree.props.selected === true; });
    ...
    var result = (react_1.default.createElement(TreeContainer, __assign({ role: "treeitem", "aria-expanded": isOpen }, rest),
        react_1.default.createElement(TreeLine, { "$selected": selected },
            ...
            react_1.default.createElement(LabelWithFolder, { onClick: handleClick, "$selected": selected, title: label, "aria-selected": Boolean(selected) },
                react_1.default.createElement(TreeIcon, { isLoading: isLoading, isLeaf: isLeaf, selected: selected === true || selected === 'mixed' }),
                label)),
