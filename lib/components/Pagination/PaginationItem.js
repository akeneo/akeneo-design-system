...
var PaginationItem = function (_a) {
    ...
    return (react_1.default.createElement(PaginationItemContainer, { onClick: handleClick, "data-testid": "paginationItem", title: page !== PAGINATION_SEPARATOR ? "No. ".concat(page) : '', disabled: page === PAGINATION_SEPARATOR, currentPage: currentPage, type: "button" }, page));
};
exports.PaginationItem = PaginationItem;
var currentPaginationItemMixin = (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  border: 1px ", " solid;\n  color: ", ";\n"], ["\n  border: 1px ", " solid;\n  color: ", ";\n"])), (0, theme_1.getColor)('brand', 100), (0, theme_1.getColor)('brand', 100));
var otherPaginationItemMixin = (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  border: 1px ", " solid;\n  color: ", ";\n"], ["\n  border: 1px ", " solid;\n  color: ", ";\n"])), (0, theme_1.getColor)('grey', 80), (0, theme_1.getColor)('grey', 100));
var disabledMixin = (0, styled_components_1.css)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  cursor: default;\n  :hover {\n    background-color: ", ";\n  }\n"], ["\n  cursor: default;\n  :hover {\n    background-color: ", ";\n  }\n"])), (0, theme_1.getColor)('white'));
...
}, (0, theme_1.getColor)('white'), (0, theme_1.getColor)('grey', 20), function (_a) {
