...
var ProgressBarFill = styled_components_1.default.div.attrs(function (props) { return ({
    ...
    return (0, styled_components_1.css)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n    background: ", ";\n  "], ["\n    background: ", ";\n  "])), (0, theme_1.getColorForLevel)(level, light ? 60 : 100));
}, function (props) {
    return props.indeterminate && (0, styled_components_1.css)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      background-image: linear-gradient(\n        315deg,\n        rgba(255, 255, 255, 0.6) 25%,\n        rgba(255, 255, 255, 0.4) 25%,\n        rgba(255, 255, 255, 0.4) 50%,\n        rgba(255, 255, 255, 0.6) 50%,\n        rgba(255, 255, 255, 0.6) 75%,\n        rgba(255, 255, 255, 0.4) 75%,\n        rgba(255, 255, 255, 0.4) 100%\n      );\n      background-size: 20px 20px;\n      transition: width 200ms ease;\n      animation: ", " 1s linear infinite;\n    "], ["\n      background-image: linear-gradient(\n        315deg,\n        rgba(255, 255, 255, 0.6) 25%,\n        rgba(255, 255, 255, 0.4) 25%,\n        rgba(255, 255, 255, 0.4) 50%,\n        rgba(255, 255, 255, 0.6) 50%,\n        rgba(255, 255, 255, 0.6) 75%,\n        rgba(255, 255, 255, 0.4) 75%,\n        rgba(255, 255, 255, 0.4) 100%\n      );\n      background-size: 20px 20px;\n      transition: width 200ms ease;\n      animation: ", " 1s linear infinite;\n    "])), progressBarAnimation);
});
...
var ProgressBar = (0, react_1.forwardRef)(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(ProgressBarContainer, __assign({ ref: forwardedRef }, rest),
        (title || progressLabel) && (react_1.default.createElement(Header, null,
            react_1.default.createElement(Title, { title: title, id: labelId }, title),
            progressLabel && react_1.default.createElement(ProgressLabel, { title: progressLabel }, progressLabel))),
        react_1.default.createElement(ProgressBarBackground, __assign({ id: progressBarId }, progressBarProps, { role: "progressbar", size: size }),
