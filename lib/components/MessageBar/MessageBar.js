...
var Icon = (0, styled_components_1.default)(icons_1.CloseIcon)(templateObject_6 || (templateObject_6 = __makeTemplateObject([""], [""])));
var CloseButton = styled_components_1.default.button(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  position: relative;\n  width: 24px;\n  height: 24px;\n  color: ", ";\n  border: 0;\n  background: none;\n  cursor: pointer;\n  display: inline-flex;\n  font-size: ", ";\n\n  & > * {\n    position: absolute;\n    line-height: 24px;\n    width: 100%;\n    top: 0;\n    left: 0;\n    transition: opacity 0.2s ease-in-out;\n  }\n\n  ", " {\n    opacity: ", ";\n  }\n\n  :hover {\n    ", " {\n      opacity: 1;\n    }\n    ", " {\n      opacity: 0;\n    }\n  }\n"], ["\n  position: relative;\n  width: 24px;\n  height: 24px;\n  color: ", ";\n  border: 0;\n  background: none;\n  cursor: pointer;\n  display: inline-flex;\n  font-size: ", ";\n\n  & > * {\n    position: absolute;\n    line-height: 24px;\n    width: 100%;\n    top: 0;\n    left: 0;\n    transition: opacity 0.2s ease-in-out;\n  }\n\n  ", " {\n    opacity: ", ";\n  }\n\n  :hover {\n    ", " {\n      opacity: 1;\n    }\n    ", " {\n      opacity: 0;\n    }\n  }\n"])), (0, theme_1.getColor)('grey', 100), (0, theme_1.getFontSize)('bigger'), Icon, function (_a) {
    var showIcon = _a.showIcon;
    return (showIcon ? 1 : 0);
}, Icon, Timer);
var MessageBarHideAnimation = (0, styled_components_1.keyframes)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  0% {\n    transform: translateX(0);\n  }\n  75% {\n    transform: translateX(calc(100% + 50px));\n    max-height: 150px;\n    opacity: 0;\n  }\n  100% {\n    transform: translateX(calc(100% + 50px));\n    max-height: 0;\n    opacity: 0;\n  }\n"], ["\n  0% {\n    transform: translateX(0);\n  }\n  75% {\n    transform: translateX(calc(100% + 50px));\n    max-height: 150px;\n    opacity: 0;\n  }\n  100% {\n    transform: translateX(calc(100% + 50px));\n    max-height: 0;\n    opacity: 0;\n  }\n"])));
...
var AnimateMessageBar = function (_a) {
    ...
    var _b = (0, react_1.useState)(false), unmounting = _b[0], setUnmounting = _b[1];
...
var getLevelColor = function (level) {
    switch (level) {
        case 'info':
            return (0, theme_1.getColor)('blue', 100);
        case 'success':
            return (0, theme_1.getColor)('green', 100);
        case 'warning':
            return (0, theme_1.getColor)('yellow', 120);
        case 'error':
            return (0, theme_1.getColor)('red', 100);
    }
};
...
var useOver = function () {
    var _a = (0, react_1.useState)(false), over = _a[0], setOver = _a[1];
    var onMouseOver = (0, react_1.useCallback)(function () {
        setOver(true);
    }, []);
    var onMouseOut = (0, react_1.useCallback)(function () {
        setOver(false);
    }, []);
...
var MessageBar = function (_a) {
    ...
    var _c = (0, react_1.useState)(duration), remaining = _c[0], setRemaining = _c[1];
