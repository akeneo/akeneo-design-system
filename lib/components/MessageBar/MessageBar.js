...
var MessageBar = function (_a) {
    ...
    var autoHide = !react_1.default.Children.toArray(children).some(function (child) { return react_1.isValidElement(child) && child.type === components_1.Link; });
    var _c = react_1.useState(autoHide ? duration : 0), remaining = _c[0], setRemaining = _c[1];
    ...
    return (react_1.default.createElement(Container, { ref: ref, tabIndex: -1, role: 'error' === level ? 'alert' : 'status', level: level, onMouseOver: onMouseOver, onMouseOut: onMouseOut },
        ...
        react_1.default.createElement(Content, null,
            ...
            children),
        react_1.default.createElement(CloseButton, { onClick: onClose, autoHide: autoHide && !countDownFinished, title: dismissTitle },
            react_1.default.createElement(Timer, { "aria-hidden": "true" },
                remainingDisplay,
                autoHide && (react_1.default.createElement(Progress, { ratio: Math.max(0, remaining / duration), level: level },
