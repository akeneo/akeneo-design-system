...
var Pill = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return react_1.default.createElement(PillContainer, __assign({ role: level === 'danger' ? 'alert' : undefined, level: level, ref: forwardedRef }, rest));
});
exports.Pill = Pill;
