...
`,A=r.default(f)`
  ...
  display: flex;
  gap: 10px;
`,E=r.default(f)``,h=l=>{var o=l,{children:e}=o,t=c(o,["children"]);return a.jsx(E,p(u({width:"auto"},t),{children:e}))},F=r.default.div`
  display: flex;
  margin-left: 30px;
  gap: 10px;
`,M=r.default.div`
...
`,N=r.default.div`
  ...
  gap: 4px;
  margin-bottom: 10px;
`,z=g=>{var n=g,{children:e,isMultiline:t=!1,isSelected:l=!1}=n,o=c(n,["children","isMultiline","isSelected"]);const y=[],$=[],b=[];return C.default.Children.forEach(e,i=>{m.isValidElement(i)&&(i.type===h||i.type===R)?y.push(i):m.isValidElement(i)&&i.type===N?b.push(i):$.push(i)}),a.jsxs(M,p(u({isMultiline:t,tabIndex:0,isSelected:l},o),{children:[a.jsxs(S,{children:[a.jsx(G,{children:$}),y.length>0&&a.jsx(F,{children:y})]}),b]}))},B=g=>{var n=g,{title:e,width:t,children:l}=n,o=c(n,["title","width","children"]);return e=e===void 0&&typeof l=="string"?l:e,a.jsx(f,p(u({width:t,title:e},o),{children:l}))},R=l=>{var o=l,{children:e}=o,t=c(o,["children"]);const g=C.default.Children.map(e,n=>C.default.isValidElement(n)&&(n.type===k.Button||n.type===D.IconButton)?C.default.cloneElement(n,{size:"small",ghost:!0,level:"tertiary"}):n);return a.jsx(A,p(u({},t),{children:g}))},d=l=>{var o=l,{children:e}=o,t=c(o,["children"]);return a.jsx(H,p(u({},t),{children:e}))};z.displayName="List.Row";B.displayName="List.Cell";w.displayName="List.TitleCell";R.displayName="List.ActionCell";h.displayName="List.RemoveCell";d.Row=z;d.Cell=B;d.TitleCell=w;d.ActionCell=R;d.RemoveCell=h;d.RowHelpers=N;exports.List=d;
