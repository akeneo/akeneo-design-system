...
var CellContainer = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  min-height: 54px;\n  padding: 17px 0;\n  box-sizing: border-box;\n  font-size: ", ";\n  color: ", ";\n  display: flex;\n\n  ", ";\n"], ["\n  min-height: 54px;\n  padding: 17px 0;\n  box-sizing: border-box;\n  font-size: ", ";\n  color: ", ";\n  display: flex;\n\n  ", ";\n"])), (0, theme_1.getFontSize)('default'), (0, theme_1.getColor)('grey', 140), function (_a) {
    var width = _a.width;
    return 'auto' === width
        ? (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          flex: 1;\n        "], ["\n          flex: 1;\n        "]))) : (0, styled_components_1.css)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          width: ", "px;\n        "], ["\n          width: ", "px;\n        "])), width);
});
var TitleCell = (0, styled_components_1.default)(CellContainer)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  color: ", ";\n  font-style: italic;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n"], ["\n  color: ", ";\n  font-style: italic;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n"])), (0, theme_1.getColor)('purple', 100));
var ActionCellContainer = (0, styled_components_1.default)(CellContainer)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  opacity: 0;\n  display: flex;\n  gap: 10px;\n"], ["\n  opacity: 0;\n  display: flex;\n  gap: 10px;\n"])));
var RemoveCellContainer = (0, styled_components_1.default)(CellContainer)(templateObject_7 || (templateObject_7 = __makeTemplateObject([""], [""])));
...
var RowContainer = styled_components_1.default.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  outline-style: none;\n  padding: 0 10px;\n  border-bottom: 1px solid ", ";\n  background-color: ", ";\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  &:focus {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:hover ", " {\n    opacity: 1;\n  }\n\n  ", " {\n    align-items: ", ";\n  }\n\n  ", ", ", " {\n    height: ", ";\n    align-items: center;\n  }\n"], ["\n  display: flex;\n  flex-direction: column;\n  outline-style: none;\n  padding: 0 10px;\n  border-bottom: 1px solid ", ";\n  background-color: ", ";\n\n  &:hover {\n    background-color: ", ";\n  }\n\n  &:focus {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:hover ", " {\n    opacity: 1;\n  }\n\n  ", " {\n    align-items: ", ";\n  }\n\n  ", ", ", " {\n    height: ", ";\n    align-items: center;\n  }\n"])), (0, theme_1.getColor)('grey', 60), function (_a) {
    ...
    return (isSelected ? (0, theme_1.getColor)('blue', 20) : 'transparent');
}, (0, theme_1.getColor)('grey', 20), (0, theme_1.getColor)('blue', 40), ActionCellContainer, CellContainer, function (_a) {
...
var Row = function (_a) {
    ...
    react_1.default.Children.forEach(children, function (child) {
        if ((0, react_1.isValidElement)(child) && (child.type === RemoveCell || child.type === ActionCell)) {
            actionCellChild.push(child);
        }
        else if ((0, react_1.isValidElement)(child) && child.type === RowHelpers) {
            helpers.push(child);
        }
        else {
            cells.push(child);
    ...
    return (react_1.default.createElement(RowContainer, __assign({ isMultiline: isMultiline, tabIndex: 0, isSelected: isSelected }, rest),
