...
var getZebraBackgroundColor = function (highlighted, rowIndex) {
    return highlighted ? theme_1.getColor('blue', 10) : rowIndex % 2 === 0 ? theme_1.getColor('white') : theme_1.getColor('grey', 20);
};
var TableInputTr = styled_components_1.default.tr(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  height: 40px;\n  & > td {\n    border: 1px solid ", ";\n    border-right-width: 0;\n    border-top-width: 0;\n    line-height: 39px;\n  }\n  & > td:first-child {\n    position: sticky;\n    left: 0;\n    margin-right: -1px;\n    z-index: 2;\n  }\n\n  ", "\n\n  & > td:last-child {\n    border-right-width: 1px;\n  }\n\n  ", "\n\n  ", "\n  \n  ", "\n    \n  ", "\n"], ["\n  height: 40px;\n  & > td {\n    border: 1px solid ", ";\n    border-right-width: 0;\n    border-top-width: 0;\n    line-height: 39px;\n  }\n  & > td:first-child {\n    position: sticky;\n    left: 0;\n    margin-right: -1px;\n    z-index: 2;\n  }\n\n  ",
    ...
    "\n  \n  ",
    "\n    \n  ",
    "\n"])), theme_1.getColor('grey', 60), function (_a) {
    var isDragAndDroppable = _a.isDragAndDroppable;
    return isDragAndDroppable && styled_components_1.css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      & > td:nth-child(2) {\n        position: sticky;\n        left: 26px;\n        z-index: 1;\n        border-left: none;\n      }\n    "], ["\n      & > td:nth-child(2) {\n        position: sticky;\n        left: 26px;\n        z-index: 1;\n        border-left: none;\n      }\n    "])));
}, function (_a) {
    var placeholderPosition = _a.placeholderPosition, rowIndex = _a.rowIndex, highlighted = _a.highlighted;
    return placeholderPosition === 'bottom' && styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      & > td {\n        background: linear-gradient(\n          to top,\n          ", " 4px,\n          ", " 0px\n        );\n      }\n    "], ["\n      & > td {\n        background: linear-gradient(\n          to top,\n          ", " 4px,\n          ", " 0px\n        );\n      }\n    "])), theme_1.getColor('blue', 40), getZebraBackgroundColor(highlighted, rowIndex));
}, function (_a) {
    var placeholderPosition = _a.placeholderPosition, rowIndex = _a.rowIndex, highlighted = _a.highlighted;
    return placeholderPosition === 'top' && styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      & > td {\n        background: linear-gradient(\n          to bottom,\n          ", " 4px,\n          ", " 0px\n        );\n      }\n    "], ["\n      & > td {\n        background: linear-gradient(\n          to bottom,\n          ", " 4px,\n          ", " 0px\n        );\n      }\n    "])), theme_1.getColor('blue', 40), getZebraBackgroundColor(highlighted, rowIndex));
}, function (_a) {
    var placeholderPosition = _a.placeholderPosition, rowIndex = _a.rowIndex, highlighted = _a.highlighted;
    return placeholderPosition === 'none' && styled_components_1.css(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n      & > td {\n        background: ", ";\n      }\n    "], ["\n      & > td {\n        background: ", ";\n      }\n    "])), getZebraBackgroundColor(highlighted, rowIndex));
}, function (_a) {
    var highlighted = _a.highlighted;
    return highlighted && styled_components_1.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      & > td {\n        &:before {\n          content: '';\n          border-bottom: 1px solid ", ";\n          position: relative;\n          width: 100%;\n          display: block;\n          height: 0;\n          margin-top: -1px;\n        }\n        &:has(div) {\n          background: red !important;\n        }\n        /*box-shadow: 0 -1px 0px ", ";*/\n        border-bottom-color: ", ";\n        &:first-child {\n          border-left: 1px solid ", ";\n        }\n        &:last-child {\n          border-right: 1px solid ", ";\n        }\n      }\n    "], ["\n      & > td {\n        &:before {\n          content: '';\n          border-bottom: 1px solid ", ";\n          position: relative;\n          width: 100%;\n          display: block;\n          height: 0;\n          margin-top: -1px;\n        }\n        &:has(div) {\n          background: red !important;\n        }\n        /*box-shadow: 0 -1px 0px ", ";*/\n        border-bottom-color: ", ";\n        &:first-child {\n          border-left: 1px solid ", ";\n        }\n        &:last-child {\n          border-right: 1px solid ", ";\n        }\n      }\n    "])), theme_1.getColor('blue', 100), theme_1.getColor('blue', 100), theme_1.getColor('blue', 100), theme_1.getColor('blue', 100), theme_1.getColor('blue', 100));
});
var DragAndDropCell = styled_components_1.default(TableInputCell_1.TableInputCell)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  max-width: 26px;\n  min-width: 26px;\n  width: 26px;\n  color: ", ";\n  text-align: right;\n  cursor: grab;\n  vertical-align: middle;\n  line-height: 0px !important;\n  & > div {\n    height: 39px;\n    vertical-align: middle;\n    line-height: 44px;\n  }\n"], ["\n  max-width: 26px;\n  min-width: 26px;\n  width: 26px;\n  color: ", ";\n  text-align: right;\n  cursor: grab;\n  vertical-align: middle;\n  line-height: 0px !important;\n  & > div {\n    height: 39px;\n    vertical-align: middle;\n    line-height: 44px;\n  }\n"])), theme_1.getColor('grey', 100));
var TableInputRow = react_1.forwardRef(function (_a, forwardedRef) {
    ...
    var _d = usePlaceholderPosition_1.usePlaceholderPosition(rowIndex), placeholderPosition = _d[0], placeholderDragEnter = _d[1], placeholderDragLeave = _d[2], placeholderDragEnd = _d[3];
    var isDragAndDroppable = react_1.useContext(TableInputContext_1.TableInputContext).isDragAndDroppable;
