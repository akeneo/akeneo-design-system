...
var TableInputSelect = function (_a) {
    var value = _a.value, onClear = _a.onClear, clearLabel = _a.clearLabel, openDropdownLabel = _a.openDropdownLabel, _b = _a.highlighted, highlighted = _b === void 0 ? false : _b, _c = _a.searchValue, searchValue = _c === void 0 ? '' : _c, searchPlaceholder = _a.searchPlaceholder, onSearchChange = _a.onSearchChange, searchTitle = _a.searchTitle, onNextPage = _a.onNextPage, children = _a.children, inError = _a.inError, _d = _a.closeTick, closeTick = _d === void 0 ? false : _d, bottomHelper = _a.bottomHelper, _e = _a.withSearch, withSearch = _e === void 0 ? true : _e, rest = __rest(_a, ["value", "onClear", "clearLabel", "openDropdownLabel", "highlighted", "searchValue", "searchPlaceholder", "onSearchChange", "searchTitle", "onNextPage", "children", "inError", "closeTick", "bottomHelper", "withSearch"]);
