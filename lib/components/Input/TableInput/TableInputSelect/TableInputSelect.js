...
var SelectButton = styled_components_1.default.button(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  color: ", ";\n  width: 100%;\n  background: none;\n  border: none;\n  text-align: left;\n  display: inline-block;\n  justify-content: space-between;\n  padding: 0 70px 0 10px;\n  height: 39px;\n  line-height: 39px;\n  align-items: center;\n  cursor: pointer;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  background: none;\n\n  ", ";\n"], ["\n  color: ", ";\n  width: 100%;\n  background: none;\n  border: none;\n  text-align: left;\n  display: inline-block;\n  justify-content: space-between;\n  padding: 0 70px 0 10px;\n  height: 39px;\n  line-height: 39px;\n  align-items: center;\n  cursor: pointer;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  background: none;\n\n  ", ";\n"])), (0, theme_1.getColor)('grey', 140), highlightCell_1.highlightCell);
var IconsPart = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: inline-flex;\n  gap: 10px;\n  position: absolute;\n  right: 10px;\n  height: 39px;\n  align-items: center;\n"], ["\n  display: inline-flex;\n  gap: 10px;\n  position: absolute;\n  right: 10px;\n  height: 39px;\n  align-items: center;\n"])));
var TableInputSelect = function (_a) {
    ...
    if (readOnly) {
        return react_1.default.createElement(TableInputReadOnlyCell_1.TableInputReadOnlyCell, { title: value === null || value === void 0 ? void 0 : value.toString() }, value);
    }
    return (react_1.default.createElement(SelectButtonDropdown, __assign({}, rest),
        react_1.default.createElement(SelectButton, { onClick: function (e) {
                e.preventDefault();
                handleOpen();
            }, tabIndex: -1, highlighted: highlighted, title: value === null || value === void 0 ? void 0 : value.toString(), inError: inError },
            value,
            "\u00A0"),
