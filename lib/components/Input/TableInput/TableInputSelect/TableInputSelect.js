...
var SelectButtonDropdown = styled_components_1.default(Dropdown_1.Dropdown)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  width: 100%;\n  color: ", ";\n"], ["\n  width: 100%;\n  color: ", ";\n"])), theme_1.getColor('grey', 140));
var SelectButton = styled_components_1.default.button(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  color: ", ";\n  width: 100%;\n  background: none;\n  border: none;\n  text-align: left;\n  display: inline-block;\n  justify-content: space-between;\n  padding: 0 70px 0 10px;\n  height: 39px;\n  line-height: 39px;\n  align-items: center;\n  cursor: pointer;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  background: none;\n\n  ", ";\n\n  ", ";\n"], ["\n  color: ", ";\n  width: 100%;\n  background: none;\n  border: none;\n  text-align: left;\n  display: inline-block;\n  justify-content: space-between;\n  padding: 0 70px 0 10px;\n  height: 39px;\n  line-height: 39px;\n  align-items: center;\n  cursor: pointer;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  background: none;\n\n  ",
    ...
    return highlighted &&
        !inError && styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      background: ", ";\n      box-shadow: 0 0 0 1px ", ";\n    "], ["\n      background: ", ";\n      box-shadow: 0 0 0 1px ", ";\n    "])), theme_1.getColor('green', 10), theme_1.getColor('green', 80));
}, function (_a) {
    var inError = _a.inError;
    return inError && styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      background: ", ";\n      box-shadow: 0 0 0 1px ", ";\n    "], ["\n      background: ", ";\n      box-shadow: 0 0 0 1px ", ";\n    "])), theme_1.getColor('red', 10), theme_1.getColor('red', 80));
});
...
var TableInputSelect = function (_a) {
    var value = _a.value, onClear = _a.onClear, clearLabel = _a.clearLabel, openDropdownLabel = _a.openDropdownLabel, _b = _a.highlighted, highlighted = _b === void 0 ? false : _b, _c = _a.searchValue, searchValue = _c === void 0 ? '' : _c, searchPlaceholder = _a.searchPlaceholder, onSearchChange = _a.onSearchChange, searchTitle = _a.searchTitle, onNextPage = _a.onNextPage, children = _a.children, inError = _a.inError, _d = _a.closeTick, closeTick = _d === void 0 ? false : _d, rest = __rest(_a, ["value", "onClear", "clearLabel", "openDropdownLabel", "highlighted", "searchValue", "searchPlaceholder", "onSearchChange", "searchTitle", "onNextPage", "children", "inError", "closeTick"]);
    var _e = hooks_1.useBooleanState(false), isOpen = _e[0], open = _e[1], close = _e[2];
    ...
    return (react_1.default.createElement(SelectButtonDropdown, __assign({}, rest),
        ...
        isOpen && (react_1.default.createElement(Dropdown_1.Dropdown.Overlay, { onClose: close, dropdownOpenerVisible: true, horizontalPosition: "left" },
            react_1.default.createElement(Dropdown_1.Dropdown.Header, null,
