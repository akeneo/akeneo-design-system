...
var EditableTableInputDate = (0, styled_components_1.default)(DateInput_1.DateInput)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  height: 39px;\n  padding-left: 10px;\n  padding-right: 10px;\n  border-radius: 0;\n  border: none;\n  background: none;\n\n  ", ";\n\n  &:focus {\n    box-shadow: 0 0 0 1px ", ";\n  }\n"], ["\n  height: 39px;\n  padding-left: 10px;\n  padding-right: 10px;\n  border-radius: 0;\n  border: none;\n  background: none;\n\n  ", ";\n\n  &:focus {\n    box-shadow: 0 0 0 1px ", ";\n  }\n"])), highlightCell_1.highlightCell, (0, theme_1.getColor)('grey', 100));
var TableInputDate = function (_a) {
    ...
    if (readOnly) {
        ...
        return (react_1.default.createElement(EditableTableInputDate, __assign({ value: value }, rest), children));
};
exports.TableInputDate = TableInputDate;
TableInputRow_1.TableInputRow.displayName = 'TableInput.DateInput';
var templateObject_1;
//# sourceMappingURL=TableInputDate.js.map