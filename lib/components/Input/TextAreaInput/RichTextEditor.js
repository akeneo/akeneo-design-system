...
var editorStateToRaw = function (editorState) {
    return (0, draftjs_to_html_1.default)((0, draft_js_1.convertToRaw)(editorState.getCurrentContent()));
};
var rawToEditorState = function (value) {
    var rawDraft = (0, html_to_draftjs_1.default)(value);
...
var RichTextEditor = function (_a) {
    ...
    var _c = (0, react_1.useState)(rawToEditorState(value)), editorState = _c[0], setEditorState = _c[1];
