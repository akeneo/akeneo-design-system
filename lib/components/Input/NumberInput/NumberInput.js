...
var NumberInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(NumberInputContainer, null,
        react_1.default.createElement(Input, __assign({ ref: forwardedRef, onChange: handleChange, type: "number", readOnly: readOnly, disabled: readOnly, "aria-invalid": invalid, invalid: invalid, autoComplete: "off", value: value }, rest)),
