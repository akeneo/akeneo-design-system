...
var IncrementIconContainer = styled_components_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  position: absolute;\n  right: 0;\n  top: 0;\n  margin: 0 12px;\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  justify-content: center;\n  cursor: pointer;\n  color: ", ";\n"], ["\n  position: absolute;\n  right: 0;\n  top: 0;\n  margin: 0 12px;\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  justify-content: center;\n  cursor: pointer;\n  color: ", ";\n"])), (0, theme_1.getColor)('grey', 100));
var NumberInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    var invalid = _a.invalid, onChange = _a.onChange, readOnly = _a.readOnly, step = _a.step, value = _a.value, onSubmit = _a.onSubmit, _b = _a.withIncrementIcons, withIncrementIcons = _b === void 0 ? true : _b, rest = __rest(_a, ["invalid", "onChange", "readOnly", "step", "value", "onSubmit", "withIncrementIcons"]);
    ...
    var handleIncrement = (0, react_1.useCallback)(function () {
    ...
    var handleDecrement = (0, react_1.useCallback)(function () {
        if (forwardedRef && 'function' !== typeof forwardedRef && forwardedRef.current && !readOnly && onChange) {
    ...
    return (react_1.default.createElement(NumberInputContainer, null,
        react_1.default.createElement(Input, __assign({ ref: forwardedRef, onChange: handleChange, type: "number", readOnly: readOnly, disabled: readOnly, "aria-invalid": invalid, invalid: invalid, autoComplete: "off", value: value, title: value }, rest)),
        readOnly && react_1.default.createElement(ReadOnlyIcon, { size: 16 }),
        !readOnly && withIncrementIcons && (react_1.default.createElement(IncrementIconContainer, null,
