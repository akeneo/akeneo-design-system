...
var BooleanButton = styled_components_1.default.button(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  ", "\n  height: 40px;\n  width: 60px;\n  display: inline-block;\n  line-height: 36px;\n  text-align: center;\n  vertical-align: middle;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  background: ", ";\n\n  ", "\n"], ["\n  ", "\n  height: 40px;\n  width: 60px;\n  display: inline-block;\n  line-height: 36px;\n  text-align: center;\n  vertical-align: middle;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  background: ", ";\n\n  ",
    ...
    return readOnly
        ? styled_components_1.css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          border: 1px solid ", ";\n          color: ", ";\n          &:hover {\n            background: ", ";\n            color: ", ";\n          }\n        "], ["\n          border: 1px solid ", ";\n          color: ", ";\n          &:hover {\n            background: ", ";\n            color: ", ";\n          }\n        "])), theme_1.getColor('grey', 60), theme_1.getColor('grey', 80), theme_1.getColor('white'), theme_1.getColor('grey', 80)) : styled_components_1.css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n          border: 1px solid ", ";\n          cursor: pointer;\n          &:hover {\n            background: ", ";\n            color: ", ";\n          }\n        "], ["\n          border: 1px solid ", ";\n          cursor: pointer;\n          &:hover {\n            background: ", ";\n            color: ", ";\n          }\n        "])), invalid ? theme_1.getColor('red', 100) : theme_1.getColor('grey', 80), theme_1.getColor('grey', 20), theme_1.getColor('grey', 140));
});
var NoButton = styled_components_1.default(BooleanButton)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  border-radius: 2px 0 0 2px;\n  border-right-width: 1px;\n\n  ", "\n"], ["\n  border-radius: 2px 0 0 2px;\n  border-right-width: 1px;\n\n  ",
    "\n"])), function (_a) {
    var value = _a.value, readOnly = _a.readOnly, invalid = _a.invalid;
    return value === false && styled_components_1.css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      background: ", ";\n      border-color: ", ";\n      color: ", ";\n      &:hover {\n        background: ", ";\n        color: ", ";\n      }\n      &:active {\n        background: ", ";\n      }\n    "], ["\n      background: ", ";\n      border-color: ", ";\n      color: ", ";\n      &:hover {\n        background: ", ";\n        color: ", ";\n      }\n      &:active {\n        background: ", ";\n      }\n    "])), theme_1.getColor('grey', readOnly ? 80 : 100), invalid ? theme_1.getColor('red', 100) : theme_1.getColor('grey', readOnly ? 80 : 100), theme_1.getColor('white'), theme_1.getColor('grey', readOnly ? 80 : 120), theme_1.getColor('white'), theme_1.getColor('grey', readOnly ? 80 : 140));
});
var YesButton = styled_components_1.default(BooleanButton)(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  border-radius: 0 2px 2px 0;\n  border-left-width: 0;\n\n  ", "\n"], ["\n  border-radius: 0 2px 2px 0;\n  border-left-width: 0;\n\n  ",
    "\n"])), function (_a) {
    var value = _a.value, readOnly = _a.readOnly, invalid = _a.invalid;
    return value === true && styled_components_1.css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      background: ", ";\n      border-color: ", ";\n      color: ", ";\n\n      &:hover {\n        background: ", ";\n        color: ", ";\n      }\n\n      &:active {\n        background: ", ";\n      }\n    "], ["\n      background: ", ";\n      border-color: ", ";\n      color: ", ";\n\n      &:hover {\n        background: ", ";\n        color: ", ";\n      }\n\n      &:active {\n        background: ", ";\n      }\n    "])), theme_1.getColor('green', readOnly ? 60 : 100), invalid ? theme_1.getColor('red', 100) : theme_1.getColor('grey', readOnly ? 60 : 100), theme_1.getColor('white'), theme_1.getColor('green', readOnly ? 60 : 120), theme_1.getColor('white'), theme_1.getColor('green', readOnly ? 60 : 140));
});
...
var BooleanInputEraseIcon = styled_components_1.default(icons_1.EraseIcon)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  vertical-align: bottom;\n  margin-right: 6px;\n"], ["\n  vertical-align: bottom;\n  margin-right: 6px;\n"])));
...
var BooleanInputLockIcon = styled_components_1.default(icons_1.LockIcon)(templateObject_12 || (templateObject_12 = __makeTemplateObject([""], [""])));
var ContainerInvalid = styled_components_1.default.div(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  display: flex;\n  font-weight: 400;\n  padding-right: 20px;\n  color: ", ";\n"], ["\n  display: flex;\n  font-weight: 400;\n  padding-right: 20px;\n  color: ", ";\n"])), theme_1.getColor('red', 100));
...
var BooleanInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    var value = _a.value, readOnly = _a.readOnly, onChange = _a.onChange, _b = _a.clearable, clearable = _b === void 0 ? false : _b, yesLabel = _a.yesLabel, noLabel = _a.noLabel, clearLabel = _a.clearLabel, invalid = _a.invalid, children = _a.children, rest = __rest(_a, ["value", "readOnly", "onChange", "clearable", "yesLabel", "noLabel", "clearLabel", "invalid", "children"]);
    ...
    return (react_1.default.createElement(BooleanInputContainer, __assign({ role: "switch", "aria-checked": null === value ? undefined : value, ref: forwardedRef }, rest),
        react_1.default.createElement(NoButton, { value: value, readOnly: readOnly, "aria-readonly": readOnly, disabled: readOnly, onClick: function () {
                handleChange(false);
            }, title: noLabel, "aria-invalid": invalid, invalid: invalid }, noLabel),
        react_1.default.createElement(YesButton, { value: value, readOnly: readOnly, "aria-readonly": readOnly, disabled: readOnly, onClick: function () {
                handleChange(true);
            }, title: yesLabel, "aria-invalid": invalid, invalid: invalid }, yesLabel),
