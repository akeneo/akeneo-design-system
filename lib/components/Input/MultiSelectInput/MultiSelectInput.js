...
var MultiSelectInput = function (_a) {
    var id = _a.id, placeholder = _a.placeholder, invalid = _a.invalid, value = _a.value, emptyResultLabel = _a.emptyResultLabel, _b = _a.children, children = _b === void 0 ? [] : _b, onChange = _a.onChange, removeLabel = _a.removeLabel, onSubmit = _a.onSubmit, openLabel = _a.openLabel, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c, verticalPosition = _a.verticalPosition, onNextPage = _a.onNextPage, onSearchChange = _a.onSearchChange, ariaLabelledby = _a["aria-labelledby"], rest = __rest(_a, ["id", "placeholder", "invalid", "value", "emptyResultLabel", "children", "onChange", "removeLabel", "onSubmit", "openLabel", "readOnly", "verticalPosition", "onNextPage", "onSearchChange", 'aria-labelledby']);
    var _d = react_1.useState(''), searchValue = _d[0], setSearchValue = _d[1];
    var _e = hooks_1.useBooleanState(), dropdownIsOpen = _e[0], openOverlay = _e[1], closeOverlay = _e[2];
    ...
    usePagination_1.usePagination(optionsContainerRef, lastOptionRef, onNextPage, dropdownIsOpen);
