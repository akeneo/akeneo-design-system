...
var MultiSelectInput = function (_a) {
    var id = _a.id, placeholder = _a.placeholder, invalid = _a.invalid, value = _a.value, emptyResultLabel = _a.emptyResultLabel, _b = _a.children, children = _b === void 0 ? [] : _b, onChange = _a.onChange, removeLabel = _a.removeLabel, onSubmit = _a.onSubmit, openLabel = _a.openLabel, _c = _a.readOnly, readOnly = _c === void 0 ? false : _c, verticalPosition = _a.verticalPosition, ariaLabelledby = _a["aria-labelledby"], rest = __rest(_a, ["id", "placeholder", "invalid", "value", "emptyResultLabel", "children", "onChange", "removeLabel", "onSubmit", "openLabel", "readOnly", "verticalPosition", 'aria-labelledby']);
    ...
    return (react_1.default.createElement(MultiSelectInputContainer, __assign({ ref: containerRef, readOnly: readOnly, value: value }, rest),
        ...
        dropdownIsOpen && !readOnly && (react_1.default.createElement(common_1.Overlay, { parentRef: containerRef, verticalPosition: verticalPosition, onClose: handleBlur },
