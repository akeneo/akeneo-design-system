...
var ChipInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(Container, { invalid: invalid, readOnly: readOnly },
        ...
        react_1.default.createElement(InputContainer, null,
            react_1.default.createElement(Input, { type: "text", id: id, value: searchValue, ref: forwardedRef, placeholder: value.length === 0 ? placeholder : undefined, onChange: handleChange, onBlur: unselectLast, "aria-invalid": invalid, readOnly: readOnly, onFocus: onFocus }),
