...
var TagInput = function (_a) {
    ...
    return (react_1.default.createElement(TagContainer, { "data-testid": "tagInputContainer", ref: containerRef, invalid: invalid, onClick: focusOnInputField, readOnly: readOnly },
        value.map(function (tag, index) {
            return (react_1.default.createElement(Tag, { key: "".concat(tag, "-").concat(index), "data-testid": "tag", isSelected: index === value.length - 1 && isLastTagSelected, readOnly: readOnly, isErrored: invalidValue.includes(tag) },
                !readOnly && (react_1.default.createElement(RemoveTagIcon, { onClick: function () { return removeTag(index); }, "data-testid": "remove-".concat(index), "$isErrored": invalidValue.includes(tag) })),
