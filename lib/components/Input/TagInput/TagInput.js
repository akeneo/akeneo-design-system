...
var RemoveTagIcon = (0, styled_components_1.default)(icons_1.CloseIcon)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  min-width: 12px;\n  width: 12px;\n  height: 12px;\n  margin-right: 2px;\n  cursor: pointer;\n  color: ", ";\n"], ["\n  min-width: 12px;\n  width: 12px;\n  height: 12px;\n  margin-right: 2px;\n  cursor: pointer;\n  color: ", ";\n"])), function (_a) {
    ...
    return ($isErrored ? (0, theme_1.getColor)('red', 100) : (0, theme_1.getColor)('grey', 120));
});
...
var Tag = styled_components_1.default.li(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  list-style-type: none;\n  padding: ", ";\n  border: 1px ", " solid;\n  background-color: ", ";\n  display: flex;\n  align-items: center;\n  height: 30px;\n  box-sizing: border-box;\n  max-width: 100%;\n  color: ", ";\n"], ["\n  list-style-type: none;\n  padding: ", ";\n  border: 1px ", " solid;\n  background-color: ", ";\n  display: flex;\n  align-items: center;\n  height: 30px;\n  box-sizing: border-box;\n  max-width: 100%;\n  color: ", ";\n"])), function (_a) {
    ...
    var isErrored = _a.isErrored;
    return (isErrored ? (0, theme_1.getColor)('red', 80) : (0, theme_1.getColor)('grey', 80));
}, function (_a) {
...
var TagInput = function (_a) {
    ...
    var _e = (0, react_1.useState)(false), isLastTagSelected = _e[0], setLastTagAsSelected = _e[1];
    ...
    var getLabel = (0, react_1.useCallback)(function (tag) {
        var _a;
        return 'undefined' === typeof labels ? tag : (_a = labels[tag]) !== null && _a !== void 0 ? _a : "[" + tag + "]";
    }, [labels]);
    return (react_1.default.createElement(TagContainer, { "data-testid": "tagInputContainer", ref: containerRef, invalid: invalid, onClick: focusOnInputField, readOnly: readOnly },
        value.map(function (tag, index) {
            return (react_1.default.createElement(Tag, { key: tag + "-" + index, "data-testid": "tag", isSelected: index === value.length - 1 && isLastTagSelected, readOnly: readOnly, isErrored: invalidValue.includes(tag) },
                !readOnly && (react_1.default.createElement(RemoveTagIcon, { onClick: function () { return removeTag(index); }, "data-testid": "remove-" + index, "$isErrored": invalidValue.includes(tag) })),
                react_1.default.createElement(TagText, null, getLabel(tag))));
        }),
        react_1.default.createElement(InputContainer, { ref: inputContainerRef, onClick: focusOnInputField, hasTags: value.length > 0 },
