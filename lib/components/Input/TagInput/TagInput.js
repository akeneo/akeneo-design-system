...
var TagInput = function (_a) {
    var onChange = _a.onChange, placeholder = _a.placeholder, invalid = _a.invalid, _b = _a.value, value = _b === void 0 ? [] : _b, readOnly = _a.readOnly, inputProps = __rest(_a, ["onChange", "placeholder", "invalid", "value", "readOnly"]);
    ...
    var removeTag = react_1.useCallback(function (tagIndexToRemove) {
        var clonedTags = __spreadArrays(value);
    ...
    var handleTagDeletion = react_1.useCallback(function (event) {
    ...
    return (react_1.default.createElement(TagContainer, { "data-testid": "tagInputContainer", ref: containerRef, invalid: invalid, onClick: focusOnInputField, readOnly: readOnly },
        ...
        react_1.default.createElement(InputContainer, { ref: inputContainerRef, onClick: focusOnInputField },
            react_1.default.createElement("input", __assign({ type: "text", "data-testid": "tag-input", ref: inputRef, placeholder: value.length === 0 ? placeholder : '', onKeyDown: handleTagDeletion, onChange: onChangeCreateTags, onBlurCapture: onBlurCreateTag, "aria-invalid": invalid, readOnly: readOnly }, inputProps)),
