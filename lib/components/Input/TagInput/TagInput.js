...
var TagInput = function (_a) {
    ...
    var _c = (0, react_1.useState)(false), isLastTagSelected = _c[0], setLastTagAsSelected = _c[1];
    ...
    var onBlurCreateTag = (0, react_1.useCallback)(function (event) {
    ...
    var createTags = (0, react_1.useCallback)(function (newTags) {
    ...
    var removeTag = (0, react_1.useCallback)(function (tagIndexToRemove) {
        var clonedTags = __spreadArray([], value, true);
        clonedTags.splice(tagIndexToRemove, 1);
        onChange(clonedTags);
    }, [value, onChange]);
    var focusOnInputField = (0, react_1.useCallback)(function (event) {
        if (inputRef &&
            inputRef.current &&
