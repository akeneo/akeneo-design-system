...
var MediaFileInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var _f = hooks_1.useBooleanState(false), isUploading = _f[0], startUploading = _f[1], stopUploading = _f[2];
    var _g = react_1.useState(thumbnailUrl), displayedThumbnailUrl = _g[0], setDisplayedThumbnailUrl = _g[1];
    var _h = hooks_1.useBooleanState(false), hasUploadFailed = _h[0], uploadFailed = _h[1], uploadSucceeded = _h[2];
    var _j = react_1.useState(0), progress = _j[0], setProgress = _j[1];
