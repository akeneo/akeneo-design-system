...
var MediaFileLabel = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  font-size: ", ";\n  font-weight: normal;\n  color: ", ";\n  flex-grow: 1;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n"], ["\n  font-size: ", ";\n  font-weight: normal;\n  color: ", ";\n  flex-grow: 1;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n"])), (0, theme_1.getFontSize)('default'), (0, theme_1.getColor)('grey', 140));
var MediaFilePlaceholder = (0, styled_components_1.default)(MediaFileLabel)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), (0, theme_1.getColor)('grey', 120));
...
var ActionContainer = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  ", "\n\n  display: flex;\n  gap: 2px;\n  align-items: center;\n  color: ", ";\n"], ["\n  ", "\n\n  display: flex;\n  gap: 2px;\n  align-items: center;\n  color: ", ";\n"])), function (_a) {
    var isCompact = _a.isCompact;
    return !isCompact && (0, styled_components_1.css)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      position: absolute;\n      top: 8px;\n      right: 8px;\n    "], ["\n      position: absolute;\n      top: 8px;\n      right: 8px;\n    "])));
}, (0, theme_1.getColor)('grey', 100));
var UploadProgress = (0, styled_components_1.default)(ProgressBar_1.ProgressBar)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  flex: 1;\n  width: 100%;\n"], ["\n  flex: 1;\n  width: 100%;\n"])));
...
var MediaFileInput = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var _f = (0, hooks_1.useBooleanState)(false), isUploading = _f[0], startUploading = _f[1], stopUploading = _f[2];
    var _g = (0, react_1.useState)(thumbnailUrl), displayedThumbnailUrl = _g[0], setDisplayedThumbnailUrl = _g[1];
    var _h = (0, hooks_1.useBooleanState)(false), hasUploadFailed = _h[0], uploadFailed = _h[1], uploadSucceeded = _h[2];
    ...
    (0, hooks_1.useShortcut)(shared_1.Key.Enter, openFileExplorer, containerRef);
    var actions = react_1.default.Children.map(children, function (child) {
        if ((0, react_1.isValidElement)(child) && IconButton_1.IconButton === child.type) {
    ...
    return (react_1.default.createElement(MediaFileInputContainer, { ref: containerRef, tabIndex: readOnly ? -1 : 0, invalid: invalid || hasUploadFailed, readOnly: readOnly, isCompact: isCompact, className: className },
        ...
        isUploading ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(UploadProgress, { title: uploadingLabel, progressLabel: "".concat(Math.round(progress * 100), "%"), level: "primary", percent: progress * 100 }))) : null !== value ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(MediaFileImage, { height: isCompact ? 47 : 120, width: isCompact ? 47 : 120, src: displayedThumbnailUrl, alt: value.originalFilename, fit: "contain", onError: function () { return setDisplayedThumbnailUrl(DefaultPicture_svg_1.default); } }),
            readOnly ? (react_1.default.createElement(MediaFilePlaceholder, null, value.originalFilename)) : (react_1.default.createElement(MediaFileLabel, { title: value.originalFilename }, value.originalFilename)))) : (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(illustrations_1.ImportIllustration, { size: isCompact ? 47 : 140 }),
        ...
        react_1.default.createElement(ActionContainer, { isCompact: isCompact },
            value && (react_1.default.createElement(react_1.default.Fragment, null,
                !readOnly && clearable && (react_1.default.createElement(IconButton_1.IconButton, { size: "small", level: "tertiary", ghost: "borderless", icon: react_1.default.createElement(icons_1.CloseIcon, null), title: clearTitle, onClick: handleClear })),
                actions)),
