...
var SelectInput = function (_a) {
    var _b;
    var id = _a.id, placeholder = _a.placeholder, invalid = _a.invalid, value = _a.value, emptyResultLabel = _a.emptyResultLabel, children = _a.children, onChange = _a.onChange, _c = _a.clearable, clearable = _c === void 0 ? true : _c, _d = _a.clearLabel, clearLabel = _d === void 0 ? '' : _d, _e = _a.openLabel, openLabel = _e === void 0 ? '' : _e, _f = _a.readOnly, readOnly = _f === void 0 ? false : _f, _g = _a.verticalPosition, verticalPosition = _g === void 0 ? 'down' : _g, ariaLabelledby = _a["aria-labelledby"], rest = __rest(_a, ["id", "placeholder", "invalid", "value", "emptyResultLabel", "children", "onChange", "clearable", "clearLabel", "openLabel", "readOnly", "verticalPosition", 'aria-labelledby']);
    var _h = react_1.useState(''), searchValue = _h[0], setSearchValue = _h[1];
    var _j = hooks_1.useBooleanState(), dropdownIsOpen = _j[0], openOverlay = _j[1], closeOverlay = _j[2];
    ...
    return (react_1.default.createElement(SelectInputContainer, __assign({ readOnly: readOnly, value: value }, rest),
        react_1.default.createElement(InputContainer, null,
            ...
            !readOnly && (react_1.default.createElement(ActionContainer, null,
                ...
                react_1.default.createElement(components_1.IconButton, { ghost: "borderless", level: "tertiary", size: "small", icon: react_1.default.createElement(OpenButton, null), title: openLabel, onClick: handleFocus, onFocus: handleBlur, tabIndex: 0 })))),
