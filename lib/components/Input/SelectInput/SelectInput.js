...
var SelectInput = function (_a) {
    ...
    return (react_1.default.createElement(SelectInputContainer, __assign({ readOnly: readOnly, value: value }, rest),
        react_1.default.createElement(InputContainer, null,
            ...
            react_1.default.createElement(components_1.TextInput, { id: id, ref: inputRef, value: searchValue, readOnly: readOnly, invalid: invalid, placeholder: null === value ? placeholder : '', onChange: handleSearch, onClick: function (e) {
                    openOverlay();
                    e.preventDefault();
            ...
            !readOnly && (react_1.default.createElement(ActionContainer, null,
                ...
                react_1.default.createElement(components_1.IconButton, { ghost: "borderless", level: "tertiary", size: "small", icon: react_1.default.createElement(icons_1.ArrowDownIcon, null), title: openLabel, onClick: openOverlay, onFocus: handleEscape, tabIndex: -1 })))),
