...
var Content = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  max-height: ", "px;\n  overflow: ", ";\n  transition: max-height ", "ms ease-in-out;\n  padding-bottom: ", "px;\n"], ["\n  max-height: ", "px;\n  overflow: ", ";\n  transition: max-height ", "ms ease-in-out;\n  padding-bottom: ", "px;\n"])), function (_a) {
    ...
    return overflow;
}, ANIMATION_DURATION, function (_a) {
    var $height = _a.$height;
...
var Collapse = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var _c = react_1.useState(isOpen ? 'inherit' : 'hidden'), overflow = _c[0], setOverflow = _c[1];
    var contentRef = react_1.useRef(null);
    var isMounted = hooks_1.useIsMounted();
    var handleCollapse = function () { return onCollapse(!isOpen); };
    react_1.useEffect(function () {
        if (contentRef.current) {
            if (isOpen) {
                setContentHeight(contentRef.current.scrollHeight);
                var timeoutId_1 = window.setTimeout(function () { return isMounted() && setOverflow('inherit'); }, ANIMATION_DURATION);
    ...
    return (react_1.default.createElement(CollapseContainer, __assign({ ref: forwardedRef }, rest),
        react_1.default.createElement(LabelContainer, null,
            ...
            react_1.default.createElement(components_1.IconButton, { size: "small", level: "tertiary", ghost: "borderless", onClick: handleCollapse, title: collapseButtonLabel, icon: isOpen ? react_1.default.createElement(icons_1.CheckPartialIcon, null) : react_1.default.createElement(icons_1.PlusIcon, null) })),
        react_1.default.createElement(Content, { ref: contentRef, overflow: overflow, "$height": contentHeight }, children)));
});
