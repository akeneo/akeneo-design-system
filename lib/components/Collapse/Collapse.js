...
var Collapse = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(CollapseContainer, __assign({ ref: forwardedRef, isOpen: isOpen }, rest),
