...
var Information = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var resizedIllustration = (0, react_1.isValidElement)(illustration) && react_1.default.cloneElement(illustration, { size: 80 });
