...
`,E=l.default.div`
  ...
  white-space: nowrap;
`,s=r=>{var o=r,{children:e}=o,t=d(o,["children"]);const v=a.Children.map(e,n=>a.isValidElement(n)&&n.type===$.IconButton?a.cloneElement(n,{level:"tertiary",size:"small",ghost:"borderless"}):a.isValidElement(n)&&n.type===S.Button?a.cloneElement(n,p({level:"tertiary",size:"small",ghost:!0},n.props)):n);return x.jsx(z,m(p({},t),{children:v}))};s.Title=T;s.Spacer=_;s.Separator=B;s.Information=E;exports.SectionTitle=s;
