...
var SubNavigationItem = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    return (react_1.default.createElement(Container, __assign({ ref: forwardedRef, href: disabled ? undefined : href, active: active, disabled: disabled, "aria-disabled": disabled, role: "link", onClick: handleClick }, rest),
