...
`,u=s.default.div`
  padding: 10px 5px;
`,c=i.default.forwardRef((M,q)=>{var f=M,{children:e,isOpen:t=!0,open:o,close:n,closeTitle:P="",openTitle:w="",noPadding:_=!1}=f,j=C(f,["children","isOpen","open","close","closeTitle","openTitle","noPadding"]);const g=[],p=[];i.default.Children.forEach(e,r=>{i.default.isValidElement(r)&&r.type===u?g.push(r):p.push(r)});const[N,E]=i.default.useState(t);return m.useLayoutEffect(()=>{E(t)},[t]),a.jsxs(B,h(y({ref:q,$isOpen:t},j),{children:[!t&&g,a.jsx(D,{$isOpen:N,$noPadding:_,children:t&&p}),a.jsx(L,{onClick:()=>t?n():o(),title:t?P:w,"data-testid":"open-subnavigation-button",children:t?a.jsx(T.PanelCloseIcon,{}):a.jsx(z.PanelOpenIcon,{})})]}))});c.displayName="SubNavigationPanel";u.displayName="SubNavigationPanel.Collapsed";c.Collapsed=u;exports.SubNavigationPanel=c;
