...
var Link = styled_components_1.default.a(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  align-items: center;\n  box-sizing: border-box;\n  cursor: ", ";\n  display: flex;\n  flex-direction: column;\n  font-size: ", ";\n  height: 70px;\n  justify-content: center;\n  line-height: 1.15;\n  margin: 0;\n  outline-style: none;\n  padding: 7px;\n  position: relative;\n  text-decoration: none;\n  width: 80px;\n\n  border-left: 4px solid\n    ", ";\n\n  color: ", ";\n\n  svg {\n    color: ", ";\n  }\n\n  :hover {\n    border-color: ", ";\n    color: ", ";\n    svg {\n      color: ", ";\n    }\n  }\n\n  :focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n    outline: none;\n  }\n"], ["\n  align-items: center;\n  box-sizing: border-box;\n  cursor: ", ";\n  display: flex;\n  flex-direction: column;\n  font-size: ", ";\n  height: 70px;\n  justify-content: center;\n  line-height: 1.15;\n  margin: 0;\n  outline-style: none;\n  padding: 7px;\n  position: relative;\n  text-decoration: none;\n  width: 80px;\n\n  border-left: 4px solid\n    ", ";\n\n  color: ", ";\n\n  svg {\n    color: ", ";\n  }\n\n  :hover {\n    border-color: ", ";\n    color: ", ";\n    svg {\n      color: ", ";\n    }\n  }\n\n  :focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n    outline: none;\n  }\n"])), function (_a) {
    ...
    return !disabled && active ? (0, theme_1.getColor)('brand', 100) : 'transparent';
}, function (_a) {
    var active = _a.active, disabled = _a.disabled;
    return disabled ? (0, theme_1.getColor)('grey', 100) : active ? (0, theme_1.getColor)('brand', 100) : (0, theme_1.getColor)('grey', 120);
}, function (_a) {
    var active = _a.active, disabled = _a.disabled;
    return disabled ? (0, theme_1.getColor)('grey', 80) : active ? (0, theme_1.getColor)('brand', 100) : (0, theme_1.getColor)('grey', 100);
}, function (_a) {
    var disabled = _a.disabled;
