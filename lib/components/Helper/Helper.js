...
var getBackgroundColor = function (level) {
    switch (level) {
        case 'info':
            return (0, theme_1.getColor)('blue', 10);
        case 'warning':
            return (0, theme_1.getColor)('yellow', 10);
        case 'error':
            return (0, theme_1.getColor)('red', 10);
        case 'success':
            return (0, theme_1.getColor)('green', 10);
    }
};
var getFontColor = function (level, inline) {
    switch (level) {
        ...
        case 'warning':
            return (0, theme_1.getColor)(inline ? 'grey' : 'yellow', 120);
        case 'error':
            return (0, theme_1.getColor)('red', inline ? 100 : 120);
        case 'success':
            return (0, theme_1.getColor)(inline ? 'grey' : 'green', 120);
    }
};
var getIconColor = function (level, inline) {
    switch (level) {
        ...
        case 'warning':
            return (0, theme_1.getColor)('yellow', inline ? 100 : 120);
        case 'error':
            return (0, theme_1.getColor)('red', inline ? 100 : 120);
        case 'success':
...
var getSeparatorColor = function (level) {
    switch (level) {
        ...
        case 'error':
            return (0, theme_1.getColor)('red', 120);
        case 'success':
            return (0, theme_1.getColor)('green', 120);
    }
};
