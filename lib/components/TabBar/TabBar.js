...
}, theme_1.getFontSize('big'), theme_1.getColor('brand', 100), theme_1.getColor('brand', 100));
var HiddenTabsDropdown = styled_components_1.default(components_1.Dropdown)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"], ["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
    return (isActive ? theme_1.getColor('brand', 100) : 'transparent');
...
var TabBar = function (_a) {
    ...
    var hiddenTabs = react_1.default.Children.toArray(decoratedChildren).filter(function (child, index) { return react_1.isValidElement(child) && hiddenElements.includes(index); });
