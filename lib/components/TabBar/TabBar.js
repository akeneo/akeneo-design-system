...
var HiddenTabsDropdown = (0, styled_components_1.default)(Dropdown_1.Dropdown)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"], ["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
    return (isActive ? (0, theme_1.getColor)('brand', 100) : 'transparent');
...
var TabBar = function (_a) {
    ...
    return (react_1.default.createElement(Container, __assign({}, rest),
        ...
        0 < hiddenTabs.length && (react_1.default.createElement(HiddenTabsDropdown, { isActive: activeTabIsHidden },
            react_1.default.createElement(IconButton_1.IconButton, { level: "tertiary", ghost: "borderless", icon: react_1.default.createElement(icons_1.MoreIcon, null), title: moreButtonTitle, onClick: open }),
            isOpen && (react_1.default.createElement(Dropdown_1.Dropdown.Overlay, { verticalPosition: "down", onClose: close },
                react_1.default.createElement(Dropdown_1.Dropdown.ItemCollection, null, hiddenTabs.map(function (child, index) {
                    var handleClick = function () {
                        var _a, _b;
                        close();
                        (_b = (_a = child.props).onClick) === null || _b === void 0 ? void 0 : _b.call(_a);
                    };
                    return (react_1.default.createElement(Dropdown_1.Dropdown.Item, { key: index, onClick: handleClick, isActive: child.props.isActive }, child.props.children));
                }))))))));
};
