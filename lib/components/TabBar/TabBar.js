...
var Container = styled_components_1.default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid ", ";\n  background: ", ";\n\n  ", "\n"], ["\n  display: flex;\n  align-items: center;\n  border-bottom: 1px solid ", ";\n  background: ", ";\n\n  ",
    "\n"])), theme_1.getColor('grey', 80), theme_1.getColor('white'), function (_a) {
...
var HiddenTabsDropdown = styled_components_1.default(components_1.Dropdown)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"], ["\n  border-bottom: 3px solid ", ";\n  margin-bottom: -1px;\n  height: 44px;\n  box-sizing: border-box;\n  align-items: center;\n\n  &:hover {\n    color: ", ";\n    border-bottom: 3px solid ", ";\n  }\n"])), function (_a) {
    var isActive = _a.isActive;
    return (isActive ? theme_1.getColor('brand', 100) : 'transparent');
