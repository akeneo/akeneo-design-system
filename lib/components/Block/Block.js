...
var Block = react_1.default.forwardRef(function (_a, forwardedRef) {
    var title = _a.title, actions = _a.actions, ariaDescribedBy = _a.ariaDescribedBy, ariaLabel = _a.ariaLabel, ariaLabelledBy = _a.ariaLabelledBy, isOpen = _a.isOpen, onCollapse = _a.onCollapse, children = _a.children, rest = __rest(_a, ["title", "actions", "ariaDescribedBy", "ariaLabel", "ariaLabelledBy", "isOpen", "onCollapse", "children"]);
    ...
    var isCollapsable = undefined !== onCollapse && undefined !== isOpen;
    ...
    return (react_1.default.createElement(Container, __assign({ "aria-describedby": ariaDescribedBy, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, ref: forwardedRef }, rest),
        react_1.default.createElement(BlockTitle, null,
            ...
            react_1.default.createElement(ActionsContainer, null,
                actions,
                !isCollapsable ? null : (react_1.default.createElement(IconButton_1.IconButton, { icon: isOpen ? react_1.default.createElement(icons_1.ArrowUpIcon, null) : react_1.default.createElement(icons_1.ArrowDownIcon, null), title: "Collapse", level: "tertiary", ghost: true, size: "small", onClick: handleCollapse })))),
