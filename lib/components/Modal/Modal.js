...
exports.Title = exports.SectionTitle = exports.Modal = void 0;
...
var ModalCloseButton = styled_components_1.default(components_1.IconButton)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n  left: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n  left: 40px;\n"])));
...
var ModalChildren = styled_components_1.default.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  padding: 20px 0;\n  width: 480px;\n"], ["\n  display: flex;\n  flex-direction: column;\n  padding: 20px 0;\n  width: 480px;\n"])));
...
var Modal = function (_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, illustration = _a.illustration, children = _a.children, rest = __rest(_a, ["isOpen", "onClose", "illustration", "children"]);
    hooks_1.useShortcut(shared_1.Key.Escape, onClose);
    var containerRef = react_1.useRef(document.createElement('div'));
    ...
    if (!isOpen)
        return null;
    return react_dom_1.createPortal(react_1.default.createElement(ModalContainer, __assign({}, rest),
        react_1.default.createElement(ModalCloseButton, { level: "tertiary", ghost: "borderless", icon: react_1.default.createElement(icons_1.CloseIcon, null), onClick: onClose }),
        undefined === illustration ? (children) : (react_1.default.createElement(ModalContent, null,
            react_1.default.cloneElement(illustration, { size: 220 }),
...
exports.Modal = Modal;
Modal.BottomButtons = styled_components_1.default.div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  gap: 10px;\n  margin-top: 20px;\n"], ["\n  display: flex;\n  gap: 10px;\n  margin-top: 20px;\n"])));
