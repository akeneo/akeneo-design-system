...
var ModalContainer = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", "\n  position: fixed;\n  width: 100vw;\n  height: 100vh;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  z-index: 1800;\n  overflow: hidden;\n  padding: 20px 80px;\n  box-sizing: border-box;\n"], ["\n  ", "\n  position: fixed;\n  width: 100vw;\n  height: 100vh;\n  top: 0;\n  left: 0;\n  background-color: ", ";\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  z-index: 1800;\n  overflow: hidden;\n  padding: 20px 80px;\n  box-sizing: border-box;\n"])), theme_1.CommonStyle, (0, theme_1.getColor)('white'));
var ModalCloseButton = (0, styled_components_1.default)(IconButton_1.IconButton)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: fixed;\n  top: 40px;\n  left: 40px;\n"], ["\n  position: fixed;\n  top: 40px;\n  left: 40px;\n"])));
...
var SectionTitle = styled_components_1.default.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  height: 20px;\n  color: ", ";\n  font-size: ", ";\n  text-transform: uppercase;\n"], ["\n  height: 20px;\n  color: ", ";\n  font-size: ", ";\n  text-transform: uppercase;\n"])), function (_a) {
    var color = _a.color;
    return (0, theme_1.getColor)(color !== null && color !== void 0 ? color : 'grey', 120);
}, function (_a) {
    var size = _a.size;
    return (0, theme_1.getFontSize)(size !== null && size !== void 0 ? size : 'default');
});
var Title = styled_components_1.default.div(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  height: 40px;\n  color: ", ";\n  font-size: ", ";\n  margin-bottom: 10px;\n"], ["\n  display: flex;\n  align-items: center;\n  height: 40px;\n  color: ", ";\n  font-size: ", ";\n  margin-bottom: 10px;\n"])), (0, theme_1.getColor)('grey', 140), (0, theme_1.getFontSize)('title'));
...
var Modal = function (_a) {
    ...
    var containerRef = (0, react_1.useRef)(portalNode);
