...
var Modal = function (_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, illustration = _a.illustration, closeTitle = _a.closeTitle, children = _a.children, rest = __rest(_a, ["isOpen", "onClose", "illustration", "closeTitle", "children"]);
...
Modal.TopRightButtons = styled_components_1.default(Modal.BottomButtons)(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n  right: 40px;\n  margin: 0;\n"], ["\n  position: absolute;\n  top: 40px;\n  right: 40px;\n  margin: 0;\n"])));
