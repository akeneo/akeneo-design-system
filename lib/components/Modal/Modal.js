...
var ModalCloseButton = styled_components_1.default.button(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  background: none;\n  border: none;\n  margin: 0;\n  padding: 0;\n  position: absolute;\n  top: 40px;\n  left: 40px;\n  cursor: pointer;\n  color: ", ";\n"], ["\n  background: none;\n  border: none;\n  margin: 0;\n  padding: 0;\n  position: absolute;\n  top: 40px;\n  left: 40px;\n  cursor: pointer;\n  color: ", ";\n"])), theme_1.getColor('grey', 100));
...
var Modal = function (_a) {
    ...
    return react_dom_1.createPortal(react_1.default.createElement(ModalContainer, __assign({}, rest),
        react_1.default.createElement(ModalCloseButton, { onClick: onClose },
            react_1.default.createElement(icons_1.CloseIcon, { size: 20 })),
