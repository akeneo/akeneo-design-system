...
var Link = react_1.default.forwardRef(function (_a, forwardedRef) {
    var _b = _a.disabled, disabled = _b === void 0 ? false : _b, _c = _a.decorated, decorated = _c === void 0 ? true : _c, _d = _a.target, target = _d === void 0 ? '_self' : _d, href = _a.href, children = _a.children, rest = __rest(_a, ["disabled", "decorated", "target", "href", "children"]);
    return (react_1.default.createElement(LinkContainer, __assign({ disabled: disabled, ref: forwardedRef, target: target, decorated: decorated, rel: target === '_blank' ? 'noopener noreferrer' : '' }, (!disabled ? { href: href } : {}), rest), children));
});
exports.Link = Link;
