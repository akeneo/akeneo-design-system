...
var Step = (0, styled_components_1.default)(Link_1.Link)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  text-transform: uppercase;\n  text-decoration: none;\n  color: ", ";\n"], ["\n  text-transform: uppercase;\n  text-decoration: none;\n  color: ", ";\n"])), (0, theme_1.getColor)('grey', 120));
Step.displayName = 'Breadcrumb.Step';
var BreadcrumbContainer = styled_components_1.default.nav(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  ", ":last-child {\n    color: ", ";\n    cursor: initial;\n  }\n"], ["\n  ", ":last-child {\n    color: ", ";\n    cursor: initial;\n  }\n"])), Step, (0, theme_1.getColor)('grey', 100));
var Separator = styled_components_1.default.span(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  margin: 0 0.5rem;\n"], ["\n  margin: 0 0.5rem;\n"])));
var Breadcrumb = function (_a) {
    var children = _a.children, rest = __rest(_a, ["children"]);
    var validChildren = react_1.Children.toArray(children).filter(react_1.isValidElement);
    return (react_1.default.createElement(BreadcrumbContainer, __assign({ "aria-label": "Breadcrumb" }, rest), validChildren.map(function (child, index) {
        ...
        return isLastStep ? ((0, react_1.cloneElement)(child, { 'aria-current': 'page', disabled: true })) : (react_1.default.createElement(react_1.Fragment, { key: index },
            child,
