...
var BlockButton = react_1.default.forwardRef(function (_a, forwardedRef) {
    var _b;
    ...
    return (react_1.default.createElement(Container, __assign({ disabled: disabled, "aria-describedby": ariaDescribedBy, "aria-disabled": disabled, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, ref: forwardedRef, role: "button", onClick: handleAction }, rest),
        react_1.default.createElement(ChildrenContainer, null, react_1.default.Children.map(children, function (child) {
            var _a;
        ...
        react_1.default.createElement(ActionsContainer, null, (0, react_1.isValidElement)(icon) && react_1.default.cloneElement(icon, { size: (_b = icon.props.size) !== null && _b !== void 0 ? _b : 18 }))));
});
