...
var Container = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  min-height: 80px;\n  border: 1px ", " solid;\n  box-sizing: border-box;\n  display: -ms-flexbox;\n  display: inline-flex;\n  opacity: ", ";\n  cursor: ", ";\n  background: ", "\n}\n\n;\n\n:hover {\n  border-color: ", ";\n  background: ", ";\n}\n\n:active {\n  outline: none;\n  background: ", ";\n  border-color: ", ";\n}\n\n:focus:not(:active) {\n  box-shadow: 0 0 0 2px ", ";\n  outline: none;\n}\n"], ["\n  min-height: 80px;\n  border: 1px ", " solid;\n  box-sizing: border-box;\n  display: -ms-flexbox;\n  display: inline-flex;\n  opacity: ", ";\n  cursor: ", ";\n  background: ", "\n}\n\n;\n\n:hover {\n  border-color: ", ";\n  background: ", ";\n}\n\n:active {\n  outline: none;\n  background: ", ";\n  border-color: ", ";\n}\n\n:focus:not(:active) {\n  box-shadow: 0 0 0 2px ", ";\n  outline: none;\n}\n"])), theme_1.getColor('grey', 40), function (_a) {
...
var IconCard = react_1.default.forwardRef(function (_a, forwardedRef) {
    ...
    var validIcon = react_1.isValidElement(icon) && react_1.default.cloneElement(icon, { size: 30 });
