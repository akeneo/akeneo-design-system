...
var DownloadIcon = function (_a) {
    ...
    return (react_1.default.createElement("svg", __assign({ viewBox: "0 0 24 24", width: size, height: size }, props),
        ...
        react_1.default.createElement("g", { fill: "none", fillRule: "evenodd", strokeLinecap: "round", strokeLinejoin: "round" },
            react_1.default.createElement("g", { stroke: color },
                react_1.default.createElement("path", { className: "base", d: "M17.11 17H20v5H4v-5h3" }),
                react_1.default.createElement("path", { className: "arrow", d: "M12 2v16V2zM17 13l-5 5.5L7 13h0" })))));
};
